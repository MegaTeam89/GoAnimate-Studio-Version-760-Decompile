package
{
   ...
   public class _anifire_components_skins_AssetTransitionDestinationDropDownListSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _anifire_components_skins_AssetTransitionDestinationDropDownListSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         AssetTransitionDestinationDropDownListSkin.watcherSetupUtil = new _anifire_components_skins_AssetTransitionDestinationDropDownListSkinWatcherSetupUtil();
      }
