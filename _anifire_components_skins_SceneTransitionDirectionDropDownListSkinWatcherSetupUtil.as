package
{
   ...
   public class _anifire_components_skins_SceneTransitionDirectionDropDownListSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _anifire_components_skins_SceneTransitionDirectionDropDownListSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         SceneTransitionDirectionDropDownListSkin.watcherSetupUtil = new _anifire_components_skins_SceneTransitionDirectionDropDownListSkinWatcherSetupUtil();
      }
