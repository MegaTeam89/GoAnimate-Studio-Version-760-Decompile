package
{
   import anifire.components.studio.CommunityPanel;
   import mx.binding.IWatcherSetupUtil2;
   import mx.binding.PropertyWatcher;
   import mx.core.IFlexModuleFactory;
   
   public class _anifire_components_studio_CommunityPanelWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _anifire_components_studio_CommunityPanelWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         CommunityPanel.watcherSetupUtil = new _anifire_components_studio_CommunityPanelWatcherSetupUtil();
      }
