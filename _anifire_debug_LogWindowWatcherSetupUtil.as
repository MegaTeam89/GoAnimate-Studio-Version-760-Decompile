package
{
   ...
   public class _anifire_debug_LogWindowWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _anifire_debug_LogWindowWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         LogWindow.watcherSetupUtil = new _anifire_debug_LogWindowWatcherSetupUtil();
      }
      ...
      public function setup(param1:Object, param2:Function, param3:Function, param4:Array, param5:Array) : void
      {
         ...
         param5[4] = new PropertyWatcher("logText",{"propertyChange":true},[param4[4]],param2);
