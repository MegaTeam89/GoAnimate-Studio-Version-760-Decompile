package
{
   import anifire.components.studio.FaceItemRenderer;
   import mx.binding.IWatcherSetupUtil2;
   import mx.binding.PropertyWatcher;
   import mx.core.IFlexModuleFactory;
   
   public class _anifire_components_studio_FaceItemRendererWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _anifire_components_studio_FaceItemRendererWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         FaceItemRenderer.watcherSetupUtil = new _anifire_components_studio_FaceItemRendererWatcherSetupUtil();
      }
