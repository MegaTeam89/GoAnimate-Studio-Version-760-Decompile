   ...
   public class BezierSplineControl
   {
      ...
      private function __left(param1:Number) : void
      {
         ...
         if(this.__dist > Consts.ZERO_TOL)
         {
            ...
            _loc8_ = -(_loc7_ = 2 / this.__d1) * _loc6_;
      ...
      private function __right(param1:Number) : void
      {
         ...
         try
         {
            if(this.__dist > Consts.ZERO_TOL)
            {
               _loc3_ = this.__points.length - 1;
               _loc4_ = 0.5 * (this.__points[_loc3_ - 1].X + this.__points[_loc3_].X);
               _loc5_ = 0.5 * (this.__points[_loc3_ - 1].Y + this.__points[_loc3_].Y);
               _loc6_ = this.__points[_loc3_].X - _loc4_;
               _loc7_ = this.__points[_loc3_].Y - _loc5_;
               _loc9_ = -(_loc8_ = 2 / this.__d2) * _loc7_;
            ...
            {
               this.__pX = this.__points[_loc3_].X - param1 * this.__dX2;
               this.__pY = this.__points[_loc3_].Y - param1 * this.__dY2;
            }
            _loc2_ = this.__cage[_loc3_ - 1];
            _loc2_.P0X = this.__points[_loc3_ - 1].X;
            _loc2_.P0Y = this.__points[_loc3_ - 1].Y;
            _loc2_.P1X = this.__bXNL;
            _loc2_.P1Y = this.__bYNL;
            _loc2_.P2X = this.__pX;
            _loc2_.P2Y = this.__pY;
            _loc2_.P3X = this.__points[_loc3_].X;
            _loc2_.P3Y = this.__points[_loc3_].Y;
         }
         catch(err:Error)
         {
         }
      ...
      private function __rightClosed(param1:Number) : void
      {
         ...
         var _loc3_:CubicCage = this.__cage[0];
         var _loc4_:CubicCage;
         (_loc4_ = this.__cage[_loc2_ - 1]).P0X = this.__points[_loc2_ - 1].X;
