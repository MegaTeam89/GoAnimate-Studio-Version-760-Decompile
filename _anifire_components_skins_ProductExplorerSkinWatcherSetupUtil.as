package
{
   ...
   public class _anifire_components_skins_ProductExplorerSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _anifire_components_skins_ProductExplorerSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         ProductExplorerSkin.watcherSetupUtil = new _anifire_components_skins_ProductExplorerSkinWatcherSetupUtil();
      }
