package
{
   ...
   public class _anifire_components_skins_ExpressionDropDownListSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _anifire_components_skins_ExpressionDropDownListSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         ExpressionDropDownListSkin.watcherSetupUtil = new _anifire_components_skins_ExpressionDropDownListSkinWatcherSetupUtil();
      }
