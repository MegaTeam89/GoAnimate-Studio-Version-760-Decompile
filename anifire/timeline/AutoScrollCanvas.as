package anifire.timeline
{
   ...
   public class AutoScrollCanvas extends Group
   {
      ...
      public function AutoScrollCanvas()
      {
         ...
         this.mxmlContent = [this._AutoScrollCanvas_Group2_i(),this._AutoScrollCanvas_Group3_i()];
      }
      ...
      {
         if(param1.dragSource.hasFormat(TemplateThumb.DRAG_DATA_FORMAT) || param1.dragSource.hasFormat(SceneElement.DRAG_DATA_FORMAT) || param1.dragSource.hasFormat(AnimeSound.DRAG_DATA_FORMAT) || param1.dragSource.hasFormat(SoundThumb.DRAG_DATA_FORMAT))
         {
      ...
      private function _AutoScrollCanvas_Group2_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.width = 40;
         _loc1_.percentHeight = 100;
         _loc1_.mxmlContent = [this._AutoScrollCanvas_Rect1_c()];
      ...
      private function _AutoScrollCanvas_Rect1_c() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.fill = this._AutoScrollCanvas_SolidColor1_c();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _AutoScrollCanvas_SolidColor1_c() : SolidColor
      {
      ...
      private function _AutoScrollCanvas_Group3_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.width = 40;
         _loc1_.percentHeight = 100;
         _loc1_.right = 0;
         _loc1_.mxmlContent = [this._AutoScrollCanvas_Rect2_c()];
      ...
      private function _AutoScrollCanvas_Rect2_c() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.fill = this._AutoScrollCanvas_SolidColor2_c();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _AutoScrollCanvas_SolidColor2_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         _loc1_.color = 65280;
         _loc1_.alpha = 0;
