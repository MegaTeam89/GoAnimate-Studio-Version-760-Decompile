package anifire.timeline
{
   ...
   public class TimelineRuler extends Group
   {
      ...
      public static const drawColor:uint = 10197915;
      ...
      public function TimelineRuler()
      {
         ...
         this.height = 17;
         this.mxmlContent = [this._TimelineRuler_Group2_i(),this._TimelineRuler_Line1_c()];
      ...
      protected function redraw() : void
      {
         ...
         if(_loc1_ > this._drawnWidth)
         {
            ...
            _loc3_ = 0.125 * AnimeConstants.PIXEL_PER_SEC;
            _loc4_ = _loc3_ * 4;
            _loc5_ = _loc3_ * 40;
            ...
            while(_loc6_ <= _loc1_)
            {
               if(_loc6_ % _loc3_ == 0)
               {
                  ...
                  if(_loc6_ % _loc5_ == 0)
                  {
                     ...
                     _loc8_.setStyle("fontSize",10);
                     _loc8_.setStyle("color",drawColor);
                     _loc8_.setStyle("textAlign","center");
                     _loc8_.width = 50;
                     _loc8_.x = _loc6_ - 25;
                     _loc8_.y = 2;
      ...
      protected function updateDurationLimitMarker() : void
      {
         ...
         {
            _loc1_ = FeatureManager.maxMovieDuration;
      ...
      private function _TimelineRuler_Line1_c() : Line
      {
         var _loc1_:Line = new Line();
         _loc1_.left = 0;
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.stroke = this._TimelineRuler_SolidColorStroke1_c();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _TimelineRuler_SolidColorStroke1_c() : SolidColorStroke
      {
