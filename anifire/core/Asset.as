package anifire.core
{
   ...
   public class Asset extends EventDispatcher implements IAsset, IXmlConvertable, IReferencePoint
   {
      ...
      {
         var _loc1_:String = Console.getConsole().linkageController.deleteLinkage(this);
      ...
      public function getColorArea() : Array
      {
         ...
         return UtilArray.removeDuplicates(_loc3_,true);
      }
