package anifire.core
{
   ...
   public class CharThumb extends Thumb implements ICharProduct
   {
      ...
      private function createAction(param1:String) : Action
      {
         ...
         {
            if((_loc9_ = this.ccThemeModel.getCharacterActionModel(this.ccBodyModel,param1)) && _loc9_.actionModel)
            {
      ...
      {
         if(this._thumbnailUrl && this._thumbnailUrl != "")
         {
      ...
      override public function isThumbReady(param1:String = "") : Boolean
      {
         ...
         return param1 && this.getActionById(param1).imageData != null;
      }
