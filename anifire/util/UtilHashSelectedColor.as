package anifire.util
{
   ...
   public class UtilHashSelectedColor
   {
      ...
      private var data:Vector.<SelectedColor>;
      
      public function UtilHashSelectedColor()
      {
         super();
         this.keyToIndexMap = new UtilHashMap();
         this.indexToKeyMap = new Vector.<String>();
         this.data = new Vector.<SelectedColor>();
      }
      
      public function push(param1:String, param2:SelectedColor, param3:Boolean = true) : int
      {
         var _loc4_:int = 0;
      ...
      public function insert(param1:int, param2:UtilHashSelectedColor, param3:Boolean = true) : void
      {
         var _loc4_:int = 0;
      ...
      public function containsValue(param1:SelectedColor) : Boolean
      {
         var _loc2_:int = 0;
      ...
      public function getValueByKey(param1:String) : SelectedColor
      {
         var _loc2_:* = this.keyToIndexMap.getValue(param1);
         if(_loc2_ != null)
         {
      ...
      public function getValueByIndex(param1:int) : SelectedColor
      {
         return this.data[param1];
      }
      
      public function replaceValueByIndex(param1:int, param2:SelectedColor) : void
      {
      ...
      public function replaceValueByKey(param1:String, param2:SelectedColor) : void
      {
      ...
      public function getVector() : Vector.<SelectedColor>
      {
         return this.data;
      }
      
      public function clone() : UtilHashSelectedColor
      {
      ...
      public function isIdentical(param1:UtilHashSelectedColor) : Boolean
      {
