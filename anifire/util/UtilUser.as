      ...
      private static function onUpdateAccountComplete(param1:Event) : void
      {
         ...
         try
         {
            ...
            if(data.charAt(0) == "0")
            {
               ...
               {
                  GoExtInterface.call("setNavGoBuckGoPoint",_goBuck,_goPoint);
                  GoExtInterface.call("refreshTop");
               }
            }
         }
         catch(e:Error)
         {
            UtilErrorLogger.getInstance().appendCustomError("UtilUser:acountUpdate",e);
         }
