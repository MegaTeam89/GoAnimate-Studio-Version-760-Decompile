package anifire.command
{
   ...
   public class ChangeBubbleCommand extends AssetCommand
   {
      ...
      public function ChangeBubbleCommand(param1:IAsset, param2:Boolean = true)
      {
         super(param1,param2);
         ...
         if(param1 is IMotion && (param1 as IMotion).shadow is IAsset)
         {
            this._shadowCommand = new ChangeBubbleCommand((param1 as IMotion).shadow as IAsset,false);
         }
      }
      ...
      override public function undo() : void
      {
         ...
         if(asset)
         {
            try
            {
               ...
               {
                  asset.bubble.bubbleText = BubbleAsset.promptInputText;
                  asset.bubble.redraw();
               }
            }
            catch(e:Error)
