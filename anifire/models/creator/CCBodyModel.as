package anifire.models.creator
{
   ...
   public class CCBodyModel extends EventDispatcher
   {
      ...
      public function parse(param1:XML) : void
      {
         ...
         var _loc5_:XMLList;
         var _loc6_:int = (_loc5_ = param1.component).length();
         _loc2_ = 0;
         while(_loc2_ < _loc6_)
         {
            (_loc7_ = new CCBodyComponentModel()).parse(_loc5_[_loc2_]);
         ...
         _loc6_ = (_loc5_ = param1.library).length();
         _loc2_ = 0;
         while(_loc2_ < _loc6_)
         {
         ...
         _loc6_ = (_loc5_ = param1.color).length();
         _loc2_ = 0;
         while(_loc2_ < _loc6_)
         {
            (_loc9_ = new CCColor()).parse(_loc5_[_loc2_]);
