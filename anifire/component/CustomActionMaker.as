   ...
   public class CustomActionMaker extends MovieClip implements ICharacter
   {
      ...
      public function changeColor(param1:SelectedColor, param2:String = "") : Number
      {
         ...
         if(_loc3_)
         {
            ...
            while(_loc7_ < _loc5_)
            {
               (_loc6_ = _loc3_[_loc7_]).transform.colorTransform = _loc4_;
               _loc7_++;
            }
      ...
      public function resetColor() : void
      {
         ...
         {
            _loc3_ = (_loc4_ = this._colorLookup[_loc5_]).length;
            _loc2_ = 0;
            while(_loc2_ < _loc3_)
            {
         ...
         _loc3_ = (_loc4_ = this.getShaderTargets()).length;
         _loc2_ = 0;
         while(_loc2_ < _loc3_)
         {
      ...
      public function changeColorForShader(param1:UtilHashUint) : Number
      {
         ...
         {
            (_loc11_ = _loc10_[_loc12_]).blendMode = BlendMode.NORMAL;
      ...
      private function updateEyesRect() : void
      {
         ...
         if(this._head)
         {
            ...
            _loc7_ = (_loc6_ = this.getHeadPartByName(CcLibConstant.COMPONENT_TYPE_NOSE + MC)).getBounds(this);
      ...
      public function updateLocation(param1:String, param2:Object, param3:String = "") : void
      {
         ...
         if(_loc4_ = this.head)
         {
            ...
            {
               _loc6_ = (_loc5_ = this.getSubClipByName(param1 + LIB_RIGHT)).getChildAt(0) as DisplayObjectContainer;
               ...
               _loc6_ = (_loc5_ = this.getSubClipByName(param1 + LIB_LEFT)).getChildAt(0) as DisplayObjectContainer;
               _loc5_.x = Number(param2["x"]);
               _loc5_.y = Number(param2["y"]);
               _loc6_.scaleX = Number(param2["xscale"]);
               _loc6_.scaleY = Number(param2["yscale"]);
      ...
      private function updatePropSize(param1:DisplayObjectContainer, param2:DisplayObjectContainer) : void
      {
         ...
         if(param1 && param2)
         {
            ...
            while((_loc5_ = _loc5_.parent) && _loc5_ != param2);
      ...
      public function destroy(param1:Boolean = true) : void
      {
         ...
         while(_loc2_ < _loc4_)
         {
            if(_loc5_ = _loc3_[_loc2_] as Loader)
            {
      ...
      public function resetHeadPos() : void
      {
         ...
         if(_loc1_)
         {
            ...
            while(_loc3_ < _loc2_)
            {
               (_loc4_ = _loc1_.getChildAt(_loc3_)).x = 0;
               _loc4_.y = 0;
               _loc3_++;
            }
         }
      ...
      public function updateHeadScale(param1:Number, param2:Number) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            while(_loc5_ < _loc4_)
            {
               (_loc6_ = _loc3_.getChildAt(_loc5_)).scaleX = param1;
      ...
      protected function buildColorIndexImpl(param1:Vector.<DisplayObjectContainer>) : void
      {
         ...
         while(_loc3_ < _loc2_)
         {
            if((_loc5_ = (_loc4_ = param1[_loc3_]).name) && _loc5_.indexOf("theColor_") != -1)
            {
               _loc6_ = _loc5_.substr(9);
               if(!(_loc7_ = this._colorLookup[_loc6_]))
               {
      ...
      protected function processClipContainer(param1:DisplayObjectContainer, param2:Vector.<DisplayObjectContainer>, param3:Object) : void
      {
         ...
         if(param1)
         {
            ...
            while(_loc7_ < _loc4_)
            {
               if(_loc5_ = param1.getChildAt(_loc7_) as DisplayObjectContainer)
               {
                  if(param2)
                  {
                     param2.push(_loc5_);
                  ...
                  if(param3)
                  {
                     if((_loc6_ = _loc5_.name) && !param3[_loc6_])
                     {
