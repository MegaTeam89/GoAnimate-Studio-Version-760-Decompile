   ...
   public class CustomCharacterMaker extends MovieClip implements ICharacter
   {
      ...
      private function prepareSkinByCam() : void
      {
         ...
         for(_loc5_ in this._myActionModel.libraryPaths)
         {
            ...
            if(_loc3_ != null)
            {
               (_loc7_ = new Object())["part"] = _loc5_;
               _loc6_.extraData = _loc7_;
         ...
         if(this._useImageLibrary)
         {
            if(this.charXML)
            {
               for each(_loc3_ in this.charXML.child(CcLibConstant.NODE_LIBRARY))
               {
                  ...
                  _loc9_ = 0;
                  if((_loc9_ = CcImageLibrary.library.requestImage(_loc7_,this._sceneId,_loc2_)) <= 0)
                  {
                     if(this.charZip != null)
                     {
                        if((_loc10_ = this.charZip.getEntry(_loc7_)) != null)
                        {
                     ...
                     if(_loc8_ != null)
                     {
                        (_loc11_ = new Object())["part"] = String(_loc3_.@type);
            ...
            if(this._myActionModel)
            {
               for(_loc12_ in this._myActionModel.libraryPaths)
               {
                  ...
                  if((_loc9_ = CcImageLibrary.library.requestImage(_loc7_,this._sceneId,_loc2_)) <= 0)
                  {
                     ...
                     if(_loc8_ != null)
                     {
                        (_loc11_ = new Object())["part"] = String(_loc12_);
                        _loc2_.extraData = _loc11_;
                        _loc1_.addEventDispatcher(_loc2_.contentLoaderInfo,Event.COMPLETE);
                        _loc2_.loadBytes(_loc8_);
                        ++_numTotalLoadBytes;
