package anifire.component
{
   ...
   public class CcActionLoader extends EventDispatcher
   {
      ...
      private static var _flashVars:UtilHashArray;
      ...
      private static function get flashVars() : UtilHashArray
      {
         if(!_flashVars)
         {
            _flashVars = Util.getFlashVar();
         }
         return _flashVars;
      }
      ...
      public static function getStoreUrl(param1:String, param2:String = "", param3:Number = 1) : String
      {
         ...
         var _loc5_:String;
         if((_loc5_ = flashVars.getValueByKey(ServerConstants.FLASHVAR_STORE_PATH) as String) == "" || _loc5_ == null)
         {
            _loc5_ = (_loc5_ = flashVars.getValueByKey(ServerConstants.FLASHVAR_APISERVER) as String) + ("static/store/" + _loc4_ + param1);
         }
         else
         {
      ...
      public function loadCcComponents(param1:XML, param2:Number = 0, param3:Number = 0, param4:UtilHashBytes = null, param5:Number = 1, param6:Boolean = false, param7:String = "", param8:String = "", param9:Boolean = false) : void
      {
         ...
         try
         {
            if(param1)
            {
               _loc14_ = flashVars.getValueByKey(ServerConstants.FLASHVAR_IS_VIDEO_RECORD_MODE) as String;
      ...
      public function loadCcComponentsByCam(param1:CCCharacterActionModel, param2:UtilHashBytes = null, param3:Number = 1) : void
      {
         ...
         if(param1)
         {
            _loc7_ = flashVars.getValueByKey(ServerConstants.FLASHVAR_IS_VIDEO_RECORD_MODE) as String;
            this._imageData = new Object();
            this._imageData["imageData"] = !!param2 ? param2 : new UtilHashBytes();
