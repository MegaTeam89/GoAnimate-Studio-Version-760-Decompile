package anifire.bubble
{
   ...
   public class RoundedRectangularBubble extends Bubble
   {
      ...
      override protected function drawLabel() : void
      {
         ...
         {
            if((_loc4_ = this.getChildAt(_loc1_)) is FlashEff2Flex)
            {
               return;
            }
            _loc1_++;
         ...
         _loc2_ = super.returnLabel(null,this._radius * (1 / 5),this._radius * (1 / 5));
         _loc2_.x = x;
         _loc2_.y = y;
         _loc3_ = GMath.getBubbleBounds(width,height,BubbleMgr.ROUNDRECTANGULAR,null,this._radius);
         _loc2_.x = _loc3_.x + x;
         _loc2_.y = _loc3_.y + y;
