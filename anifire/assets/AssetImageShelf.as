   ...
   public class AssetImageShelf
   {
      ...
      public function getImage(param1:Number, param2:String) : AssetImageLibraryObject
      {
         ...
         if(this._images.length > 0)
         {
            ...
            {
               if((_loc5_ = AssetImageLibraryObject(this._images[param1 - 1])).borrowerId != param2)
               {
            ...
            while(_loc4_ < this._images.length)
            {
               ...
               {
                  _loc3_ -= this._images.length;
               }
               if((_loc5_ = AssetImageLibraryObject(this._images[_loc3_])).borrowerId != param2)
               {
