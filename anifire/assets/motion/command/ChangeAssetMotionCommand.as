package anifire.assets.motion.command
{
   ...
   public class ChangeAssetMotionCommand extends AssetCommand
   {
      ...
      public function ChangeAssetMotionCommand(param1:IAsset, param2:MotionData, param3:Boolean = true, param4:Number = 1)
      {
         super(param1,param3);
      ...
      override public function execute() : void
      {
         ...
         if(this.motionAsset)
         {
            ...
            {
               (this.motionAsset.shadow as IScalable).scaleX *= this._endScaleRatio;
               (this.motionAsset.shadow as IScalable).scaleY *= this._endScaleRatio;
            }
         }
      }
