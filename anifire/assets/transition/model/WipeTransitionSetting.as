package anifire.assets.transition.model
{
   ...
   public class WipeTransitionSetting extends TransitionSetting implements IDestination, IXmlConvertable
   {
       
      
      private var _dest:DestinationSetting;
      
      public function WipeTransitionSetting()
      {
         this._dest = new DestinationSetting();
         super();
         this._dest.destination = AssetTransitionConstants.DEST_LEFT;
      }
      ...
      {
         var _loc1_:WipeTransitionSetting = new WipeTransitionSetting();
