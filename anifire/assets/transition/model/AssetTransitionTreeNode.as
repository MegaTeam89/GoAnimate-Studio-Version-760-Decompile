   ...
   public class AssetTransitionTreeNode extends TreeNode implements ITiming
   {
      ...
      public static function getTreeFromTransitionCollection(param1:AssetTransitionCollection, param2:NarrationNode = null) : TreeNode
      {
         ...
         if(param1)
         {
            ...
            {
               if((_loc8_ = _loc9_.next as AssetTransition) && _loc8_.section == AssetTransitionConstants.TIMING_BEFORE_NARRATION)
               {
            ...
            while(_loc9_.hasNext)
            {
               if((_loc8_ = _loc9_.next as AssetTransition) && _loc8_.section == AssetTransitionConstants.TIMING_WITH_NARRATION)
               {
                  _loc7_ = new AssetTransitionTreeNode(_loc8_);
                  switch(_loc8_.timing)
                  {
            ...
            while(_loc9_.hasNext)
            {
               if((_loc8_ = _loc9_.next as AssetTransition) && _loc8_.section == AssetTransitionConstants.TIMING_AFTER_NARRATION)
               {
                  _loc7_ = new AssetTransitionTreeNode(_loc8_);
                  switch(_loc8_.timing)
                  {
