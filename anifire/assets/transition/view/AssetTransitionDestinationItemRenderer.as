package anifire.assets.transition.view
{
   ...
   public class AssetTransitionDestinationItemRenderer extends ItemRenderer implements IBindingClient, IStateClient2
   {
      ...
      private var _650975208_AssetTransitionDestinationItemRenderer_SolidColor1:SolidColor;
      ...
      public function AssetTransitionDestinationItemRenderer()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_assets_transition_view_AssetTransitionDestinationItemRendererWatcherSetupUtil");
         ...
         states = [new State({
            ...
            "overrides":[new AddItems().initializeFromObject({
               ...
               "target":"_AssetTransitionDestinationItemRenderer_SolidColor1",
               "name":"color",
               "value":11649221
            })]
         })];
      ...
      private function _AssetTransitionDestinationItemRenderer_Rect1_i() : Rect
      {
         ...
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.fill = this._AssetTransitionDestinationItemRenderer_SolidColor1_i();
      ...
      private function _AssetTransitionDestinationItemRenderer_SolidColor1_i() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         _loc1_.color = 13292248;
         this._AssetTransitionDestinationItemRenderer_SolidColor1 = _loc1_;
         BindingManager.executeBindings(this,"_AssetTransitionDestinationItemRenderer_SolidColor1",this._AssetTransitionDestinationItemRenderer_SolidColor1);
         return _loc1_;
      }
      ...
      public function get _AssetTransitionDestinationItemRenderer_SolidColor1() : SolidColor
      {
         return this._650975208_AssetTransitionDestinationItemRenderer_SolidColor1;
      }
      
      public function set _AssetTransitionDestinationItemRenderer_SolidColor1(param1:SolidColor) : void
      {
         var _loc2_:Object = this._650975208_AssetTransitionDestinationItemRenderer_SolidColor1;
         if(_loc2_ !== param1)
         {
            this._650975208_AssetTransitionDestinationItemRenderer_SolidColor1 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_AssetTransitionDestinationItemRenderer_SolidColor1",_loc2_,param1));
            }
         }
      }
