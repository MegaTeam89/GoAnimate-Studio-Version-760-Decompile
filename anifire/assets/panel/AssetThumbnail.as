      ...
      protected function updateImage() : void
      {
         ...
         if(_loc1_ > 0 && _loc2_ > 0)
         {
            ...
            if(this._target is IAssetView)
            {
               ...
               if(_loc10_ = IAssetView(this._target).assetImage)
               {
                  _loc4_ = IAssetImage(_loc10_).rect;
                  _loc8_ = 0.9 * Math.min(_loc1_ / _loc4_.width,_loc2_ / _loc4_.height);
                  _loc6_ = -_loc4_.x;
                  _loc7_ = -_loc4_.y;
            ...
            {
               _loc14_ = (_loc13_ = this._target as TextCollectionController).viewCollection;
               _loc4_ = _loc13_.rect;
               ...
               {
                  if(_loc19_ = (_loc18_ = IAssetView(_loc17_.next)).asset as Asset)
                  {
                     if(_loc20_ = _loc18_.assetImage)
                     {
                        _loc6_ = ((_loc21_ = new Rectangle(_loc19_.x,_loc19_.y,_loc19_.width,_loc19_.height)).x - _loc4_.x) * _loc8_ + _loc15_;
