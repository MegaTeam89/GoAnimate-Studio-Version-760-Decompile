package anifire.assets.control
{
   ...
   import anifire.assets.motion.command.ChangeMotionPathCommand;
   import anifire.assets.motion.command.RemoveAssetMovementCommand;
   import anifire.assets.view.AssetCollectionShadowView;
   ...
   public class AssetMotionControl extends UIComponent
   {
      ...
      private function onMotionPathChange(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            ...
            case AssetMotionPathEvent.PATH_ORIENTED_CHANGED:
               if(this._target as IAsset)
               {
                  _loc2_ = new ChangeMotionPathCommand(this._target as IAsset,this._motionPath.path,this._motionPath.pathOriented);
               }
            ...
            case AssetMotionPathEvent.MOTION_PATH_REMOVED:
               if(this._target as IAsset)
               {
                  _loc2_ = new RemoveAssetMovementCommand(this._target as IAsset);
               }
               else if(this._target is AssetCollectionController)
               {
      ...
      private function onShadowMouseDown(param1:MouseEvent) : void
      {
         ...
         if(this._sceneEditor && this._sceneEditor.controller.snapTool)
         {
            this._sceneEditor.controller.snapTool.updateReference(this._sceneEditor);
            if(this._shadow is IMovable)
            {
               this._sceneEditor.controller.snapTool.snapPoint(new Point(IMovable(this._shadow).x,IMovable(this._shadow).y));
            }
         }
      ...
      private function onMouseMove(param1:MouseEvent) : void
      {
         ...
         if(this._sceneEditor.controller.snapTool)
         {
      ...
      private function snapPoint(param1:Point) : void
      {
         ...
         if(this._sceneEditor)
         {
            ...
            _loc3_ = this._sceneEditor.controller.snapTool.snapRect(_loc2_);
