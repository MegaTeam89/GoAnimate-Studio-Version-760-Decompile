package anifire.popups
{
   ...
   public class UpdateGoBuck extends Canvas implements IBindingClient
   {
      
      private static var _watcherSetupUtil:IWatcherSetupUtil2;
       
      
      public var _UpdateGoBuck_Text1:Text;
      
      public var _UpdateGoBuck_Text2:Text;
      ...
      mx_internal var _UpdateGoBuck_StylesInit_done:Boolean = false;
      ...
      public function UpdateGoBuck()
      {
         var target:Object = null;
         var watcherSetupUtilClass:Object = null;
         this._documentDescriptor_ = new UIComponentDescriptor({
            "type":Canvas,
            "events":{"creationComplete":"___UpdateGoBuck_Canvas1_creationComplete"},
         ...
         var bindings:Array = this._UpdateGoBuck_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_popups_UpdateGoBuckWatcherSetupUtil");
         ...
         this._UpdateGoBuck_DropShadowFilter1_i();
         this.addEventListener("creationComplete",this.___UpdateGoBuck_Canvas1_creationComplete);
         var i:uint = 0;
      ...
      {
         UpdateGoBuck._watcherSetupUtil = param1;
      }
      ...
      override public function set moduleFactory(param1:IFlexModuleFactory) : void
      {
         ...
         mx_internal::_UpdateGoBuck_StylesInit();
      }
      ...
      private function _UpdateGoBuck_DropShadowFilter1_i() : DropShadowFilter
      {
      ...
      public function ___UpdateGoBuck_Canvas1_creationComplete(param1:FlexEvent) : void
      {
         this.init();
      }
      ...
      private function _UpdateGoBuck_bindingsSetup() : Array
      {
         var result:Array = [];
         ...
         },null,"_UpdateGoBuck_Text1.text");
         result[2] = new Binding(this,function():String
         {
            var _loc1_:* = UtilDict.toDisplay("go","Complete the transaction in the browser window that just opened and press \'Ok\' to update your GoBucks balance.");
            return _loc1_ == undefined ? null : String(_loc1_);
         },null,"_UpdateGoBuck_Text2.text");
      ...
      mx_internal function _UpdateGoBuck_StylesInit() : void
      {
         ...
         if(mx_internal::_UpdateGoBuck_StylesInit_done)
         {
            return;
         }
         mx_internal::_UpdateGoBuck_StylesInit_done = true;
         selector = null;
         conditions = null;
         conditions = [];
