package anifire.popups
{
   ...
   public class UpdateAccountForStudio extends Canvas implements IBindingClient
   {
      
      private static var _watcherSetupUtil:IWatcherSetupUtil2;
       
      
      public var _UpdateAccountForStudio_Text1:Text;
      
      public var _UpdateAccountForStudio_Text2:Text;
      ...
      mx_internal var _UpdateAccountForStudio_StylesInit_done:Boolean = false;
      ...
      public function UpdateAccountForStudio()
      {
         var target:Object = null;
         var watcherSetupUtilClass:Object = null;
         this._documentDescriptor_ = new UIComponentDescriptor({
            "type":Canvas,
            "events":{"creationComplete":"___UpdateAccountForStudio_Canvas1_creationComplete"},
                  ...
                  "propertiesFactory":function():Object
                  {
                     return {
                        ...
                        "childDescriptors":[new UIComponentDescriptor({
                           "type":Text,
                           "id":"_UpdateAccountForStudio_Text1",
                           "stylesFactory":function():void
                           {
                              this.color = 7829367;
                           ...
                           "type":Text,
                           "id":"_UpdateAccountForStudio_Text2",
                           "stylesFactory":function():void
                           {
                              this.color = 0;
                              this.textAlign = "center";
         ...
         var bindings:Array = this._UpdateAccountForStudio_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_popups_UpdateAccountForStudioWatcherSetupUtil");
         ...
         {
            return UpdateAccountForStudio[param1];
         },bindings,watchers);
         ...
         this._UpdateAccountForStudio_DropShadowFilter1_i();
         this.addEventListener("creationComplete",this.___UpdateAccountForStudio_Canvas1_creationComplete);
         var i:uint = 0;
      ...
      {
         UpdateAccountForStudio._watcherSetupUtil = param1;
      }
      ...
      override public function set moduleFactory(param1:IFlexModuleFactory) : void
      {
         ...
         mx_internal::_UpdateAccountForStudio_StylesInit();
      }
      ...
      private function _UpdateAccountForStudio_DropShadowFilter1_i() : DropShadowFilter
      {
      ...
      public function ___UpdateAccountForStudio_Canvas1_creationComplete(param1:FlexEvent) : void
      {
         this.init();
      }
      ...
      private function _UpdateAccountForStudio_bindingsSetup() : Array
      {
         var result:Array = [];
         ...
         },null,"_UpdateAccountForStudio_Text1.text");
         result[2] = new Binding(this,function():String
         {
            var _loc1_:* = UtilDict.toDisplay("go","Complete the transaction in the browser window that just opened and reload this page to enable the changes.");
            return _loc1_ == undefined ? null : String(_loc1_);
         },null,"_UpdateAccountForStudio_Text2.text");
      ...
      mx_internal function _UpdateAccountForStudio_StylesInit() : void
      {
         ...
         if(mx_internal::_UpdateAccountForStudio_StylesInit_done)
         {
            return;
         }
         mx_internal::_UpdateAccountForStudio_StylesInit_done = true;
         selector = null;
         conditions = null;
         conditions = [];
         condition = new CSSCondition("class","btnOk");
         ...
         conditions = null;
         conditions = [];
         condition = new CSSCondition("class","btnCancel");
         conditions.push(condition);
         selector = new CSSSelector("",conditions,selector);
