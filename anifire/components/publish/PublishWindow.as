...
{
   import anifire.components.skins.PublishBlackButtonSkin;
   import anifire.components.skins.PublishBlueButtonSkin;
   import anifire.components.studio.DecoratedRadioButton;
   import anifire.components.studio.DefaultPopUpContainer;
   import anifire.components.studio.IconButton;
   import anifire.constant.ServerConstants;
   import anifire.core.Console;
   import anifire.core.PublishGroup;
   ...
   public class PublishWindow extends DefaultPopUpContainer implements IBindingClient, IStateClient2
   {
      ...
      private var _1274637074_PublishWindow_Group2:Group;
      ...
      private var _58242057_PublishWindow_VGroup1:VGroup;
      ...
      private var _1061294085_radioDraft:DecoratedRadioButton;
      
      private var _230640921_radioPrivate:DecoratedRadioButton;
      
      private var _1113266043_radioPublic:DecoratedRadioButton;
      ...
      private var _1052739438publishGroupList:DropDownList;
      ...
      private var _676505710upgradeButton:Button;
      
      private var _528206064validatorList:Array;
      
      private var _1563553081watermarkBox:Group;
      ...
      public function PublishWindow()
      {
         ...
         var _PublishWindow_IconButton1_factory:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._PublishWindow_IconButton1_i);
         var _PublishWindow_VGroup1_factory:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._PublishWindow_VGroup1_i);
         var _PublishWindow_WatermarkPanel1_factory:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._PublishWindow_WatermarkPanel1_i);
         states = [new State({
            "name":"normal",
            "overrides":[new AddItems().initializeFromObject({
               "itemsFactory":_PublishWindow_IconButton1_factory,
               "destination":"contentContainer",
               "propertyName":"mxmlContent",
               "position":"after",
               "relativeTo":["panel"]
            }),new AddItems().initializeFromObject({
               "itemsFactory":_PublishWindow_VGroup1_factory,
               "destination":"_PublishWindow_Group2",
               "propertyName":"mxmlContent",
               "position":"first"
            }),new SetProperty().initializeFromObject({
               "target":"_PublishWindow_VGroup1",
               "name":"enabled",
               "value":true
            })]
         }),new State({
            "name":"watermark",
            "overrides":[new AddItems().initializeFromObject({
               "itemsFactory":_PublishWindow_WatermarkPanel1_factory,
               "destination":"_PublishWindow_Group2",
               "propertyName":"mxmlContent",
               "position":"first"
            })]
      ...
      public function initPublishWindow(param1:Boolean, param2:Boolean, param3:Vector.<BitmapData>, param4:String = "", param5:String = "", param6:String = "", param7:String = "", param8:int = 0) : void
      {
         this._published = param1;
         this._pShared = param2;
         this._movieName = param4;
         this._movieTags = param5;
         this._movieDescription = param6;
         this._thumbnails = param3;
         this._thumbnailIndex = param8;
         this._lanaguage = param7;
         if(this._lanaguage == "")
         {
            this._lanaguage = Util.getFlashVar().getValueByKey(ServerConstants.PARAM_LANG) as String;
         }
         this.languageSource = new ArrayCollection();
         this.languageSource.addItem(new MenuItemModel("English","en"));
         this.languageSource.addItem(new MenuItemModel("Deutsch","de"));
         this.languageSource.addItem(new MenuItemModel("Español","es"));
         this.languageSource.addItem(new MenuItemModel("Français","fr"));
         this.languageSource.addItem(new MenuItemModel("Italiano","it"));
         this.languageSource.addItem(new MenuItemModel("Português","pt"));
         this.languageSource.addItem(new MenuItemModel("简体中文 (Simplified Chinese)","sc"));
         this.languageSource.addItem(new MenuItemModel("繁體中文 (Traditional Chinese)","tc"));
         this.languageSource.addItem(new MenuItemModel("日本語 (Japanese)","jp"));
      }
      ...
      private function orderConsoleToSaveMovie() : void
      {
         ...
         _loc1_.metaData.lang = (this.languageList.selectedItem as MenuItemModel).value;
      ...
      private function initSavingOption(param1:int = -1) : void
      {
         ...
         else if(UtilSite.siteId == UtilSite.SCHOOL)
         {
            ...
            _loc3_ = _loc2_.getValueByKey("role");
            _loc4_ = _loc3_ == "student";
            this._radioPublic.visible = !_loc4_;
            this._radioPublic.includeInLayout = !_loc4_;
         ...
         {
            _loc6_ = (_loc5_ = Util.getFlashVar()).getValueByKey(ServerConstants.FLASHVAR_ED_USER_TYPE) as String;
            this._radioPrivate.includeInLayout = this._radioPrivate.visible = false;
            this._sharingOption.selection = !!this._published ? this._radioPublic : this._radioDraft;
            this._radioDraft.label = UtilDict.toDisplay("go","Private");
            this._radioPublic.label = UtilDict.toDisplay("go","pubwin_public");
      ...
      override protected function init() : void
      {
         ...
         var _loc1_:int = 0;
         while(_loc1_ < this.languageSource.length)
         {
            if(this._lanaguage == (this.languageSource[_loc1_] as MenuItemModel).value)
            {
               this.languageList.selectedIndex = _loc1_;
            }
            _loc1_++;
         }
         if(UtilUser.hasCommFeatures())
         {
            this.watermarkButton.visible = true;
            this.upgradeButton.visible = false;
         }
         else
         {
            this.watermarkButton.visible = false;
      ...
      private function onWatermarkUpdated() : void
      {
         ...
         this.thumbnailChooser.updateWatermark();
      }
      ...
      {
         return [this._PublishWindow_Group1_i()];
      }
      ...
      private function _PublishWindow_Group1_i() : Group
      {
         ...
         _loc1_.top = 150;
         _loc1_.mxmlContent = [this._PublishWindow_Panel1_i()];
      ...
      private function _PublishWindow_Panel1_i() : Panel
      {
         var _loc1_:Panel = new Panel();
         _loc1_.width = 760;
         _loc1_.height = 520;
         _loc1_.layout = this._PublishWindow_VerticalLayout1_c();
         _loc1_.mxmlContentFactory = new DeferredInstanceFromFunction(this._PublishWindow_Array8_c);
         _loc1_.id = "panel";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _PublishWindow_VerticalLayout1_c() : VerticalLayout
      {
      ...
      private function _PublishWindow_Array8_c() : Array
      {
         return [this._PublishWindow_Group2_i()];
      }
      
      private function _PublishWindow_Group2_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.mxmlContent = [];
         _loc1_.id = "_PublishWindow_Group2";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this._PublishWindow_Group2 = _loc1_;
         BindingManager.executeBindings(this,"_PublishWindow_Group2",this._PublishWindow_Group2);
         return _loc1_;
      }
      ...
      private function _PublishWindow_VGroup1_i() : VGroup
      {
         ...
         _loc1_.mxmlContent = [this._PublishWindow_VGroup2_c(),this._PublishWindow_HGroup1_c(),this._PublishWindow_Label6_i(),this._PublishWindow_VGroup5_i(),this._PublishWindow_HGroup3_c()];
         _loc1_.id = "_PublishWindow_VGroup1";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this._PublishWindow_VGroup1 = _loc1_;
         BindingManager.executeBindings(this,"_PublishWindow_VGroup1",this._PublishWindow_VGroup1);
         return _loc1_;
      }
      ...
      private function _PublishWindow_VGroup2_c() : VGroup
      {
         ...
         _loc1_.mxmlContent = [this._PublishWindow_Label1_i(),this._PublishWindow_Label2_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      {
         return [this._PublishWindow_FormItem1_i(),this._PublishWindow_FormItem2_i(),this._PublishWindow_FormItem3_i(),this._PublishWindow_FormItem4_i(),this._PublishWindow_FormItem5_i(),this._PublishWindow_FormItem6_i()];
      }
      ...
      {
         return [this._PublishWindow_TextInput1_i()];
      }
      ...
      {
         var _loc1_:FormItem = new FormItem();
         _loc1_.helpContent = [this._PublishWindow_Label3_i()];
      ...
      private function _PublishWindow_Label3_i() : Label
      {
         var _loc1_:Label = new Label();
         _loc1_.setStyle("color",10066329);
         _loc1_.id = "_PublishWindow_Label3";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this._PublishWindow_Label3 = _loc1_;
         BindingManager.executeBindings(this,"_PublishWindow_Label3",this._PublishWindow_Label3);
         return _loc1_;
      }
      
      private function _PublishWindow_Array16_c() : Array
      {
         return [this._PublishWindow_TextInput2_i()];
      }
      ...
      {
         var _loc1_:FormItem = new FormItem();
         _loc1_.mxmlContentFactory = new DeferredInstanceFromFunction(this._PublishWindow_Array17_c);
      ...
      private function _PublishWindow_Array17_c() : Array
      {
         return [this._PublishWindow_TextArea1_i()];
      }
      ...
      private function _PublishWindow_FormItem4_i() : FormItem
      {
         ...
         this._vbLang = _loc1_;
         BindingManager.executeBindings(this,"_vbLang",this._vbLang);
         return _loc1_;
      }
      
      private function _PublishWindow_Array18_c() : Array
      {
         return [this._PublishWindow_DropDownList1_i()];
      }
      
      private function _PublishWindow_DropDownList1_i() : DropDownList
      {
      ...
      {
         return [this._PublishWindow_HGroup2_c()];
      }
      ...
      private function _PublishWindow_HGroup2_c() : HGroup
      {
         ...
         _loc1_.mxmlContent = [this._PublishWindow_DecoratedRadioButton1_i(),this._PublishWindow_DecoratedRadioButton2_i(),this._PublishWindow_DecoratedRadioButton3_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _PublishWindow_DecoratedRadioButton1_i() : DecoratedRadioButton
      {
         ...
         _loc1_.setStyle("overlayBackgroundColor",3158064);
      ...
      private function _PublishWindow_DecoratedRadioButton2_i() : DecoratedRadioButton
      {
         var _loc1_:DecoratedRadioButton = new DecoratedRadioButton();
         _loc1_.groupName = "_sharingOption";
         _loc1_.setStyle("overlayColor",16777215);
      ...
      private function _PublishWindow_DecoratedRadioButton3_i() : DecoratedRadioButton
      {
         var _loc1_:DecoratedRadioButton = new DecoratedRadioButton();
         _loc1_.groupName = "_sharingOption";
         _loc1_.setStyle("overlayColor",16777215);
      ...
      private function _PublishWindow_FormItem6_i() : FormItem
      {
         var _loc1_:FormItem = new FormItem();
         _loc1_.required = true;
         _loc1_.includeInLayout = false;
         _loc1_.visible = false;
         _loc1_.mxmlContentFactory = new DeferredInstanceFromFunction(this._PublishWindow_Array21_c);
         _loc1_.id = "_vbGroup";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _PublishWindow_Array21_c() : Array
      {
         return [this._PublishWindow_DropDownList2_i(),this._PublishWindow_Label4_i()];
      }
      
      private function _PublishWindow_DropDownList2_i() : DropDownList
      {
         var _loc1_:DropDownList = new DropDownList();
         _loc1_.percentWidth = 100;
         _loc1_.setStyle("fontSize",14);
      ...
      private function _PublishWindow_VGroup3_c() : VGroup
      {
         ...
         _loc1_.width = 220;
         _loc1_.paddingTop = 5;
         _loc1_.mxmlContent = [this._PublishWindow_SceneThumbnailChooser1_i(),this._PublishWindow_Group3_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _PublishWindow_Group3_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.percentWidth = 100;
         _loc1_.mxmlContent = [this._PublishWindow_Rect1_c(),this._PublishWindow_VGroup4_c()];
      ...
      private function _PublishWindow_Rect1_c() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.radiusX = 5;
         _loc1_.fill = this._PublishWindow_SolidColor1_c();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _PublishWindow_SolidColor1_c() : SolidColor
      {
      ...
      private function _PublishWindow_VGroup4_c() : VGroup
      {
         var _loc1_:VGroup = new VGroup();
         _loc1_.paddingBottom = 10;
         _loc1_.paddingTop = 10;
         _loc1_.horizontalAlign = "center";
         _loc1_.percentWidth = 100;
         _loc1_.mxmlContent = [this._PublishWindow_Label5_i(),this._PublishWindow_Group4_c()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _PublishWindow_Label5_i() : Label
      {
         var _loc1_:Label = new Label();
         _loc1_.setStyle("fontSize",14);
         _loc1_.id = "_PublishWindow_Label5";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this._PublishWindow_Label5 = _loc1_;
         BindingManager.executeBindings(this,"_PublishWindow_Label5",this._PublishWindow_Label5);
         return _loc1_;
      }
      
      private function _PublishWindow_Group4_c() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.mxmlContent = [this._PublishWindow_Button1_i(),this._PublishWindow_Button2_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _PublishWindow_VGroup5_i() : VGroup
      {
         ...
         _loc1_.includeInLayout = false;
         _loc1_.visible = false;
         _loc1_.mxmlContent = [this._PublishWindow_Label7_i(),this._PublishWindow_Line1_c()];
         _loc1_.id = "schoolTip";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _PublishWindow_Label7_i() : Label
      {
         var _loc1_:Label = new Label();
         _loc1_.horizontalCenter = 0;
         _loc1_.setStyle("fontSize",16);
         _loc1_.setStyle("color",11184810);
         _loc1_.id = "_PublishWindow_Label7";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this._PublishWindow_Label7 = _loc1_;
         BindingManager.executeBindings(this,"_PublishWindow_Label7",this._PublishWindow_Label7);
         return _loc1_;
      }
      ...
      private function _PublishWindow_HGroup3_c() : HGroup
      {
         ...
         _loc1_.mxmlContent = [this._PublishWindow_Button3_i(),this._PublishWindow_Button4_i(),this._PublishWindow_Spacer1_c(),this._PublishWindow_Button5_i(),this._PublishWindow_Spacer2_i(),this._PublishWindow_Button6_i()];
         _loc1_.setStyle("fontSize",16);
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _PublishWindow_Button3_i() : Button
      {
         ...
         _loc1_.height = 32;
         _loc1_.buttonMode = true;
         _loc1_.setStyle("skinClass",PublishBlackButtonSkin);
      ...
      private function _PublishWindow_Spacer1_c() : Spacer
      {
      ...
      private function _PublishWindow_Button5_i() : Button
      {
         ...
         _loc1_.visible = false;
         _loc1_.includeInLayout = false;
         _loc1_.setStyle("skinClass",PublishBlueButtonSkin);
      ...
      private function _PublishWindow_Spacer2_i() : Spacer
      {
         var _loc1_:Spacer = new Spacer();
         _loc1_.percentWidth = 100;
         _loc1_.includeInLayout = false;
         ...
         this.spacer1 = _loc1_;
         BindingManager.executeBindings(this,"spacer1",this.spacer1);
         return _loc1_;
      }
      ...
      private function _PublishWindow_WatermarkPanel1_i() : WatermarkPanel
      {
         ...
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.addEventListener("cancel",this.__watermarkPanel_cancel);
         _loc1_.addEventListener("complete",this.__watermarkPanel_complete);
      ...
      public function __watermarkPanel_complete(param1:Event) : void
      {
         this.onWatermarkUpdated();
      }
      
      private function _PublishWindow_IconButton1_i() : IconButton
      {
      ...
      private function _PublishWindow_bindingsSetup() : Array
      {
         ...
         result[7] = new Binding(this,function():String
         {
            ...
            return _loc1_ == undefined ? null : String(_loc1_);
         },null,"_PublishWindow_Label3.text");
         ...
         {
            var _loc1_:* = UtilDict.toDisplay("go","Watermark Settings");
            return _loc1_ == undefined ? null : String(_loc1_);
         },null,"_PublishWindow_Label5.text");
         ...
         result[20] = new Binding(this,function():String
         {
            ...
            return _loc1_ == undefined ? null : String(_loc1_);
         },null,"_PublishWindow_Label7.text");
      ...
      public function get _PublishWindow_Group2() : Group
      {
         return this._1274637074_PublishWindow_Group2;
      }
      
      public function set _PublishWindow_Group2(param1:Group) : void
      {
         var _loc2_:Object = this._1274637074_PublishWindow_Group2;
         if(_loc2_ !== param1)
         {
            this._1274637074_PublishWindow_Group2 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_PublishWindow_Group2",_loc2_,param1));
            }
         }
      }
      
      [Bindable(event="propertyChange")]
      public function get _PublishWindow_VGroup1() : VGroup
      {
         return this._58242057_PublishWindow_VGroup1;
      }
      
      public function set _PublishWindow_VGroup1(param1:VGroup) : void
      {
         var _loc2_:Object = this._58242057_PublishWindow_VGroup1;
         if(_loc2_ !== param1)
         {
            this._58242057_PublishWindow_VGroup1 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_PublishWindow_VGroup1",_loc2_,param1));
            }
         }
      }
      ...
      [Bindable(event="propertyChange")]
      public function get _radioDraft() : DecoratedRadioButton
      {
         return this._1061294085_radioDraft;
      }
      
      public function set _radioDraft(param1:DecoratedRadioButton) : void
      {
      ...
      [Bindable(event="propertyChange")]
      public function get _radioPrivate() : DecoratedRadioButton
      {
         return this._230640921_radioPrivate;
      }
      
      public function set _radioPrivate(param1:DecoratedRadioButton) : void
      {
      ...
      [Bindable(event="propertyChange")]
      public function get _radioPublic() : DecoratedRadioButton
      {
         return this._1113266043_radioPublic;
      }
      
      public function set _radioPublic(param1:DecoratedRadioButton) : void
      {
      ...
      [Bindable(event="propertyChange")]
      public function get publishGroupList() : DropDownList
      {
         return this._1052739438publishGroupList;
      }
      
      public function set publishGroupList(param1:DropDownList) : void
      {
      ...
      [Bindable(event="propertyChange")]
      public function get upgradeButton() : Button
      {
         return this._676505710upgradeButton;
      }
      
      public function set upgradeButton(param1:Button) : void
      {
      ...
      [Bindable(event="propertyChange")]
      public function get watermarkBox() : Group
      {
         return this._1563553081watermarkBox;
      }
      
      public function set watermarkBox(param1:Group) : void
      {
