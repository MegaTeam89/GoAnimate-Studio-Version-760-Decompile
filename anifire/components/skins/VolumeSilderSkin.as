package anifire.components.skins
{
   ...
   public class VolumeSilderSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function VolumeSilderSkin()
      {
         super();
         mx_internal::_document = this;
         this.minWidth = 11;
         this.mxmlContent = [this._VolumeSilderSkin_Button1_i(),this._VolumeSilderSkin_Button2_i()];
         this.currentState = "normal";
         this._VolumeSilderSkin_ClassFactory1_i();
         states = [new State({
            "name":"normal",
            "overrides":[]
         }),new State({
      ...
      private function _VolumeSilderSkin_ClassFactory1_i() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = VolumeSilderSkinInnerClass0;
      ...
      private function _VolumeSilderSkin_Button1_i() : Button
      {
      ...
      private function _VolumeSilderSkin_Button2_i() : Button
      {
         var _loc1_:Button = new Button();
         _loc1_.left = 0;
         _loc1_.right = 0;
