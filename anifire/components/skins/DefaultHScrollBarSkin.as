package anifire.components.skins
{
   ...
   public class DefaultHScrollBarSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function DefaultHScrollBarSkin()
      {
         super();
         mx_internal::_document = this;
         this.minWidth = 35;
         this.minHeight = 15;
         this.mxmlContent = [this._DefaultHScrollBarSkin_Button1_i(),this._DefaultHScrollBarSkin_Button2_i()];
      ...
      private function _DefaultHScrollBarSkin_Button1_i() : Button
      {
         ...
         _loc1_.setStyle("skinClass",DefaultHScrollBarTrackSkin);
         _loc1_.id = "track";
         if(!_loc1_.document)
         {
      ...
      private function _DefaultHScrollBarSkin_Button2_i() : Button
      {
         var _loc1_:Button = new Button();
         _loc1_.focusEnabled = false;
         _loc1_.tabEnabled = false;
         _loc1_.setStyle("skinClass",DefaultHScrollBarThumbSkin);
         _loc1_.id = "thumb";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
