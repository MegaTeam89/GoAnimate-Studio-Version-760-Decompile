package anifire.components.skins
{
   ...
   public class MenuItemListSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function MenuItemListSkin()
      {
         ...
         this.mxmlContent = [this._MenuItemListSkin_RectangularDropShadow1_c(),this._MenuItemListSkin_Rect1_i(),this._MenuItemListSkin_Scroller1_i()];
      ...
      private function _MenuItemListSkin_RectangularDropShadow1_c() : RectangularDropShadow
      {
      ...
      private function _MenuItemListSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.bottom = 0;
         _loc1_.radiusX = 3;
         _loc1_.stroke = this._MenuItemListSkin_SolidColorStroke1_i();
         _loc1_.fill = this._MenuItemListSkin_SolidColor1_i();
      ...
      private function _MenuItemListSkin_SolidColorStroke1_i() : SolidColorStroke
      {
      ...
      private function _MenuItemListSkin_SolidColor1_i() : SolidColor
      {
      ...
      private function _MenuItemListSkin_Scroller1_i() : Scroller
      {
         ...
         _loc1_.viewport = this._MenuItemListSkin_DataGroup1_i();
         _loc1_.id = "scroller";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
