package anifire.components.skins
{
   ...
   public class ProductExplorerSkin extends Skin implements IBindingClient, IStateClient2
   {
      ...
      public var _ProductExplorerSkin_HGroup1:HGroup;
      ...
      public function ProductExplorerSkin()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_components_skins_ProductExplorerSkinWatcherSetupUtil");
         ...
         this.transitions = [this._ProductExplorerSkin_Transition1_c()];
         this.mxmlContent = [this._ProductExplorerSkin_Group1_i()];
      ...
      private function _ProductExplorerSkin_Group1_i() : Group
      {
         ...
         _loc1_.mxmlContent = [this._ProductExplorerSkin_Rect1_c(),this._ProductExplorerSkin_HGroup1_i(),this._ProductExplorerSkin_Group3_i()];
      ...
      private function _ProductExplorerSkin_HGroup1_i() : HGroup
      {
         ...
         _loc1_.id = "_ProductExplorerSkin_HGroup1";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this._ProductExplorerSkin_HGroup1 = _loc1_;
         BindingManager.executeBindings(this,"_ProductExplorerSkin_HGroup1",this._ProductExplorerSkin_HGroup1);
         return _loc1_;
      }
      ...
      private function _ProductExplorerSkin_Group3_i() : Group
      {
         ...
         _loc1_.left = 0;
         _loc1_.percentHeight = 100;
         _loc1_.mxmlContent = [this._ProductExplorerSkin_Line1_c(),this._ProductExplorerSkin_Rect2_c(),this._ProductExplorerSkin_VGroup2_c()];
      ...
      private function _ProductExplorerSkin_VGroup2_c() : VGroup
      {
         ...
         _loc1_.paddingBottom = 1;
         _loc1_.gap = 0;
         _loc1_.mxmlContent = [this._ProductExplorerSkin_HGroup2_c(),this._ProductExplorerSkin_Line2_c(),this._ProductExplorerSkin_List2_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ProductExplorerSkin_HGroup2_c() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.percentWidth = 100;
         ...
         _loc1_.mxmlContent = [this._ProductExplorerSkin_FocusTextInput1_i()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      private function _ProductExplorerSkin_FocusTextInput1_i() : FocusTextInput
      {
      ...
      private function _ProductExplorerSkin_bindingsSetup() : Array
      {
         ...
         },null,"_ProductExplorerSkin_HGroup1.left");
