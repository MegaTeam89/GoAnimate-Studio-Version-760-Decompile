package anifire.components.skins
{
   ...
   public class DefaultNumericStepperTextInputSkin extends SparkSkin implements IStateClient2
   {
      
      private static const exclusions:Array = ["background","textDisplay","border"];
      
      private static const exclusions_4_0:Array = ["background","textDisplay"];
      ...
      public function DefaultNumericStepperTextInputSkin()
      {
         super();
         mx_internal::_document = this;
         this.mxmlContent = [this._DefaultNumericStepperTextInputSkin_Rect1_i(),this._DefaultNumericStepperTextInputSkin_Rect2_i(),this._DefaultNumericStepperTextInputSkin_Rect3_i(),this._DefaultNumericStepperTextInputSkin_RichEditableText1_i()];
      ...
      private function _DefaultNumericStepperTextInputSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.bottom = 0;
         _loc1_.alpha = 0;
         _loc1_.stroke = this._DefaultNumericStepperTextInputSkin_SolidColorStroke1_i();
      ...
      private function _DefaultNumericStepperTextInputSkin_SolidColorStroke1_i() : SolidColorStroke
      {
      ...
      private function _DefaultNumericStepperTextInputSkin_Rect2_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 1;
         _loc1_.right = 1;
         ...
         _loc1_.bottom = 1;
         _loc1_.alpha = 0;
         _loc1_.fill = this._DefaultNumericStepperTextInputSkin_SolidColor1_i();
      ...
      private function _DefaultNumericStepperTextInputSkin_SolidColor1_i() : SolidColor
      {
      ...
      private function _DefaultNumericStepperTextInputSkin_Rect3_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 1;
         _loc1_.top = 1;
         ...
         _loc1_.height = 1;
         _loc1_.alpha = 0;
         _loc1_.fill = this._DefaultNumericStepperTextInputSkin_SolidColor2_c();
      ...
      private function _DefaultNumericStepperTextInputSkin_SolidColor2_c() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         _loc1_.color = 0;
         _loc1_.alpha = 0;
      ...
      private function _DefaultNumericStepperTextInputSkin_RichEditableText1_i() : RichEditableText
      {
