package anifire.components.skins
{
   ...
   public class FocusTextInputSkin extends SparkSkin implements IStateClient2
   {
      
      private static const focusExclusions:Array = ["textDisplay","contentGroup"];
       
      
      public var _FocusTextInputSkin_HGroup2:HGroup;
      ...
      public function FocusTextInputSkin()
      {
         super();
         mx_internal::_document = this;
         this.blendMode = "normal";
         this.mxmlContent = [this._FocusTextInputSkin_Rect1_i(),this._FocusTextInputSkin_HGroup1_i()];
         this.currentState = "normal";
         var _loc1_:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._FocusTextInputSkin_Label1_i);
         states = [new State({
            "name":"normal",
            "overrides":[]
         }),new State({
            ...
            "overrides":[new AddItems().initializeFromObject({
               ...
               "position":"after",
               "relativeTo":["_FocusTextInputSkin_HGroup2"]
            })]
         }),new State({
      ...
      private function _FocusTextInputSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.bottom = 0;
         _loc1_.radiusX = 4;
         _loc1_.fill = this._FocusTextInputSkin_SolidColor1_i();
         _loc1_.stroke = this._FocusTextInputSkin_SolidColorStroke1_i();
         _loc1_.filters = [this._FocusTextInputSkin_DropShadowFilter1_c()];
      ...
      private function _FocusTextInputSkin_SolidColor1_i() : SolidColor
      {
      ...
      private function _FocusTextInputSkin_SolidColorStroke1_i() : SolidColorStroke
      {
      ...
      private function _FocusTextInputSkin_DropShadowFilter1_c() : DropShadowFilter
      {
      ...
      private function _FocusTextInputSkin_HGroup1_i() : HGroup
      {
         ...
         _loc1_.mxmlContent = [this._FocusTextInputSkin_Group1_i()];
      ...
      private function _FocusTextInputSkin_Group1_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.mxmlContent = [this._FocusTextInputSkin_HGroup2_i()];
         _loc1_.id = "textGroup";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _FocusTextInputSkin_HGroup2_i() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.verticalAlign = "middle";
         _loc1_.gap = 3;
         _loc1_.mxmlContent = [this._FocusTextInputSkin_RichEditableText1_i(),this._FocusTextInputSkin_Button1_i()];
         _loc1_.id = "_FocusTextInputSkin_HGroup2";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
         this._FocusTextInputSkin_HGroup2 = _loc1_;
         BindingManager.executeBindings(this,"_FocusTextInputSkin_HGroup2",this._FocusTextInputSkin_HGroup2);
         return _loc1_;
      }
      
      private function _FocusTextInputSkin_RichEditableText1_i() : RichEditableText
      {
      ...
      private function _FocusTextInputSkin_Button1_i() : Button
      {
      ...
      private function _FocusTextInputSkin_Label1_i() : Label
      {
