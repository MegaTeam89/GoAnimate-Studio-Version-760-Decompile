package anifire.components.skins
{
   ...
   public class DefaultDropDownListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function DefaultDropDownListSkin()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_components_skins_DefaultDropDownListSkinWatcherSetupUtil");
      ...
      private function _DefaultDropDownListSkin_Group1_i() : Group
      {
         ...
         _loc1_.mxmlContent = [this._DefaultDropDownListSkin_RectangularDropShadow1_i(),this._DefaultDropDownListSkin_Rect1_i(),this._DefaultDropDownListSkin_Rect2_i(),this._DefaultDropDownListSkin_Scroller1_i()];
         _loc1_.id = "dropDown";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _DefaultDropDownListSkin_Rect2_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 1;
         _loc1_.right = 1;
