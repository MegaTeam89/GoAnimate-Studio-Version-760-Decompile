...
{
   import anifire.assets.transition.view.AssetTransitionDestinationItemRenderer;
   ...
   public class AssetTransitionDestinationDropDownListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function AssetTransitionDestinationDropDownListSkin()
      {
         ...
         bindings = this._AssetTransitionDestinationDropDownListSkin_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_components_skins_AssetTransitionDestinationDropDownListSkinWatcherSetupUtil");
         ...
         {
            return AssetTransitionDestinationDropDownListSkin[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._AssetTransitionDestinationDropDownListSkin_Button1_i(),this._AssetTransitionDestinationDropDownListSkin_DestinationImage1_i()];
         this.currentState = "normal";
         var _AssetTransitionDestinationDropDownListSkin_PopUpAnchor1_factory:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._AssetTransitionDestinationDropDownListSkin_PopUpAnchor1_i,this._AssetTransitionDestinationDropDownListSkin_PopUpAnchor1_r);
         states = [new State({
            "name":"normal",
            ...
            "overrides":[new AddItems().initializeFromObject({
               ...
               "itemsFactory":_AssetTransitionDestinationDropDownListSkin_PopUpAnchor1_factory,
               "destination":null,
      ...
      {
         AssetTransitionDestinationDropDownListSkin._watcherSetupUtil = param1;
      }
      ...
      private function _AssetTransitionDestinationDropDownListSkin_PopUpAnchor1_i() : PopUpAnchor
      {
         ...
         _loc1_.popUp = this._AssetTransitionDestinationDropDownListSkin_Group1_i();
         _loc1_.id = "popUp";
         if(!_loc1_.document)
         {
      ...
      private function _AssetTransitionDestinationDropDownListSkin_PopUpAnchor1_r() : void
      {
         this.popUp = null;
         this.dropDown = null;
      ...
      private function _AssetTransitionDestinationDropDownListSkin_Group1_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.mxmlContent = [this._AssetTransitionDestinationDropDownListSkin_RectangularDropShadow1_i(),this._AssetTransitionDestinationDropDownListSkin_Rect1_i(),this._AssetTransitionDestinationDropDownListSkin_Rect2_i(),this._AssetTransitionDestinationDropDownListSkin_Scroller1_i()];
         _loc1_.id = "dropDown";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _AssetTransitionDestinationDropDownListSkin_RectangularDropShadow1_i() : RectangularDropShadow
      {
      ...
      private function _AssetTransitionDestinationDropDownListSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.stroke = this._AssetTransitionDestinationDropDownListSkin_SolidColorStroke1_i();
      ...
      private function _AssetTransitionDestinationDropDownListSkin_SolidColorStroke1_i() : SolidColorStroke
      {
      ...
      private function _AssetTransitionDestinationDropDownListSkin_Rect2_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 1;
         _loc1_.right = 1;
         _loc1_.top = 1;
         _loc1_.bottom = 1;
         _loc1_.fill = this._AssetTransitionDestinationDropDownListSkin_SolidColor1_i();
      ...
      private function _AssetTransitionDestinationDropDownListSkin_SolidColor1_i() : SolidColor
      {
      ...
      private function _AssetTransitionDestinationDropDownListSkin_Scroller1_i() : Scroller
      {
         ...
         _loc1_.viewport = this._AssetTransitionDestinationDropDownListSkin_DataGroup1_i();
         _loc1_.id = "scroller";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _AssetTransitionDestinationDropDownListSkin_DataGroup1_i() : DataGroup
      {
         var _loc1_:DataGroup = new DataGroup();
         _loc1_.itemRenderer = this._AssetTransitionDestinationDropDownListSkin_ClassFactory1_c();
         _loc1_.layout = this._AssetTransitionDestinationDropDownListSkin_VerticalLayout1_c();
         _loc1_.id = "dataGroup";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _AssetTransitionDestinationDropDownListSkin_ClassFactory1_c() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = AssetTransitionDestinationItemRenderer;
         return _loc1_;
      }
      
      private function _AssetTransitionDestinationDropDownListSkin_VerticalLayout1_c() : VerticalLayout
      {
      ...
      private function _AssetTransitionDestinationDropDownListSkin_Button1_i() : Button
      {
      ...
      private function _AssetTransitionDestinationDropDownListSkin_DestinationImage1_i() : DestinationImage
      {
      ...
      private function _AssetTransitionDestinationDropDownListSkin_bindingsSetup() : Array
      {
         var result:Array = [];
         ...
         {
            return hostComponent.reverse;
         },null,"iconDisplay.reverse");
