package anifire.components.skins
{
   ...
   import anifire.components.studio.BehaviorItemRenderer;
   ...
   public class CommandHistoryDropDownListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function CommandHistoryDropDownListSkin()
      {
         ...
         bindings = this._CommandHistoryDropDownListSkin_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_components_skins_CommandHistoryDropDownListSkinWatcherSetupUtil");
         ...
         {
            return CommandHistoryDropDownListSkin[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._CommandHistoryDropDownListSkin_Button1_i()];
         this.currentState = "normal";
         var _CommandHistoryDropDownListSkin_PopUpAnchor1_factory:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._CommandHistoryDropDownListSkin_PopUpAnchor1_i,this._CommandHistoryDropDownListSkin_PopUpAnchor1_r);
         states = [new State({
            "name":"normal",
            ...
            "overrides":[new AddItems().initializeFromObject({
               ...
               "itemsFactory":_CommandHistoryDropDownListSkin_PopUpAnchor1_factory,
               "destination":null,
      ...
      {
         CommandHistoryDropDownListSkin._watcherSetupUtil = param1;
      }
      ...
      private function _CommandHistoryDropDownListSkin_PopUpAnchor1_i() : PopUpAnchor
      {
         ...
         _loc1_.popUp = this._CommandHistoryDropDownListSkin_Group1_i();
         _loc1_.id = "popUp";
         if(!_loc1_.document)
         {
      ...
      private function _CommandHistoryDropDownListSkin_PopUpAnchor1_r() : void
      {
         this.popUp = null;
         this.dropDown = null;
      ...
      private function _CommandHistoryDropDownListSkin_Group1_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.mxmlContent = [this._CommandHistoryDropDownListSkin_ArrowTipContainer1_i()];
         _loc1_.id = "dropDown";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _CommandHistoryDropDownListSkin_ArrowTipContainer1_i() : ArrowTipContainer
      {
         ...
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.targetWidth = 14;
         _loc1_.offset = 10;
         _loc1_.content = [this._CommandHistoryDropDownListSkin_Scroller1_i()];
      ...
      private function _CommandHistoryDropDownListSkin_Scroller1_i() : Scroller
      {
         ...
         _loc1_.viewport = this._CommandHistoryDropDownListSkin_DataGroup1_i();
      ...
      private function _CommandHistoryDropDownListSkin_DataGroup1_i() : DataGroup
      {
         var _loc1_:DataGroup = new DataGroup();
         _loc1_.itemRenderer = this._CommandHistoryDropDownListSkin_ClassFactory1_c();
         _loc1_.percentWidth = 100;
         _loc1_.layout = this._CommandHistoryDropDownListSkin_VerticalLayout1_c();
         _loc1_.id = "dataGroup";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _CommandHistoryDropDownListSkin_ClassFactory1_c() : ClassFactory
      {
      ...
      private function _CommandHistoryDropDownListSkin_VerticalLayout1_c() : VerticalLayout
      {
      ...
      private function _CommandHistoryDropDownListSkin_Button1_i() : Button
      {
      ...
      private function _CommandHistoryDropDownListSkin_bindingsSetup() : Array
      {
         var result:Array = [];
