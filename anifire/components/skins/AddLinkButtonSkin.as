package anifire.components.skins
{
   ...
   public class AddLinkButtonSkin extends Skin implements IStateClient2
   {
      ...
      public function AddLinkButtonSkin()
      {
         ...
         this.mxmlContent = [this._AddLinkButtonSkin_HGroup1_c()];
      ...
      private function _AddLinkButtonSkin_HGroup1_c() : HGroup
      {
         var _loc1_:HGroup = new HGroup();
         _loc1_.verticalAlign = "middle";
         _loc1_.mxmlContent = [this._AddLinkButtonSkin_BitmapImage1_i(),this._AddLinkButtonSkin_Label1_i()];
         if(!_loc1_.document)
         {
