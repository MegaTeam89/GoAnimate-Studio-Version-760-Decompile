package anifire.components.skins
{
   ...
   public class LookAtCameraToggleButtonSkin extends SparkButtonSkin implements IStateClient2
   {
      ...
      private var _embed_mxml__styles_images_tray_sideway_icon_png_606311225:Class;
      
      private var _embed_mxml__styles_images_tray_facecamera_icon_png_649710407:Class;
      
      public function LookAtCameraToggleButtonSkin()
      {
         this._embed_mxml__styles_images_tray_sideway_icon_png_606311225 = LookAtCameraToggleButtonSkin__embed_mxml__styles_images_tray_sideway_icon_png_606311225;
         this._embed_mxml__styles_images_tray_facecamera_icon_png_649710407 = LookAtCameraToggleButtonSkin__embed_mxml__styles_images_tray_facecamera_icon_png_649710407;
         super();
         ...
         states = [new State({
            ...
            "overrides":[new SetProperty().initializeFromObject({
               ...
               "name":"source",
               "value":this._embed_mxml__styles_images_tray_facecamera_icon_png_649710407
            })]
         }),new State({
      ...
      private function _LookAtCameraToggleButtonSkin_BitmapImage1_i() : BitmapImage
      {
         ...
         _loc1_.left = 8;
         _loc1_.right = 8;
         _loc1_.source = this._embed_mxml__styles_images_tray_sideway_icon_png_606311225;
