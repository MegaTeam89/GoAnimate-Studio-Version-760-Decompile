package anifire.components.skins
{
   ...
   public class AlertPanelSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function AlertPanelSkin()
      {
         ...
         bindings = this._AlertPanelSkin_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_components_skins_AlertPanelSkinWatcherSetupUtil");
         ...
         this.minWidth = 300;
         this.minHeight = 120;
         this.mxmlContent = [this._AlertPanelSkin_Group1_c()];
         this.currentState = "normal";
         var _AlertPanelSkin_Group4_factory:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._AlertPanelSkin_Group4_i);
         states = [new State({
            "name":"normal",
            ...
            "overrides":[new AddItems().initializeFromObject({
               "itemsFactory":_AlertPanelSkin_Group4_factory,
      ...
      {
         AlertPanelSkin._watcherSetupUtil = param1;
      }
      ...
      private function _AlertPanelSkin_Group1_c() : Group
      {
         ...
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.mxmlContent = [this._AlertPanelSkin_Rect1_i(),this._AlertPanelSkin_Group2_i()];
         if(!_loc1_.document)
         {
      ...
      private function _AlertPanelSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.bottom = 1;
         _loc1_.radiusX = 10;
         _loc1_.fill = this._AlertPanelSkin_SolidColor1_i();
      ...
      private function _AlertPanelSkin_SolidColor1_i() : SolidColor
      {
      ...
      private function _AlertPanelSkin_Group2_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.left = 1;
         _loc1_.right = 1;
         _loc1_.top = 1;
         _loc1_.bottom = 1;
         _loc1_.layout = this._AlertPanelSkin_VerticalLayout1_c();
         _loc1_.mxmlContent = [this._AlertPanelSkin_VGroup1_i(),this._AlertPanelSkin_Group3_i()];
         _loc1_.id = "contents";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _AlertPanelSkin_VerticalLayout1_c() : VerticalLayout
      {
      ...
      private function _AlertPanelSkin_VGroup1_i() : VGroup
      {
         ...
         _loc1_.mxmlContent = [this._AlertPanelSkin_Label1_i()];
         _loc1_.id = "topGroup";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _AlertPanelSkin_Label1_i() : Label
      {
      ...
      private function _AlertPanelSkin_Group3_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.percentWidth = 100;
      ...
      private function _AlertPanelSkin_Group4_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.minWidth = 0;
         _loc1_.minHeight = 0;
         _loc1_.mxmlContent = [this._AlertPanelSkin_Group5_i()];
      ...
      private function _AlertPanelSkin_Group5_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.left = 0;
         _loc1_.right = 0;
         ...
         _loc1_.minWidth = 0;
         _loc1_.minHeight = 0;
         _loc1_.layout = this._AlertPanelSkin_HorizontalLayout1_c();
      ...
      private function _AlertPanelSkin_HorizontalLayout1_c() : HorizontalLayout
      {
      ...
      private function _AlertPanelSkin_bindingsSetup() : Array
      {
         var result:Array = [];
