package anifire.components.skins
{
   ...
   public class TransitionListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public var _TransitionListSkin_VerticalLayout1:VerticalLayout;
      ...
      public function TransitionListSkin()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_components_skins_TransitionListSkinWatcherSetupUtil");
         ...
         this.mxmlContent = [this._TransitionListSkin_Rect1_i(),this._TransitionListSkin_Rect2_i(),this._TransitionListSkin_Scroller1_i()];
      ...
      private function _TransitionListSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.stroke = this._TransitionListSkin_SolidColorStroke1_i();
      ...
      private function _TransitionListSkin_SolidColorStroke1_i() : SolidColorStroke
      {
      ...
      private function _TransitionListSkin_Rect2_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 1;
         _loc1_.right = 1;
         _loc1_.top = 1;
         _loc1_.bottom = 1;
         _loc1_.fill = this._TransitionListSkin_SolidColor1_i();
      ...
      private function _TransitionListSkin_SolidColor1_i() : SolidColor
      {
      ...
      private function _TransitionListSkin_DataGroup1_i() : DataGroup
      {
         ...
         _loc1_.layout = this._TransitionListSkin_VerticalLayout1_i();
         _loc1_.id = "dataGroup";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _TransitionListSkin_VerticalLayout1_i() : VerticalLayout
      {
         var _loc1_:VerticalLayout = new VerticalLayout();
         _loc1_.gap = 0;
         _loc1_.horizontalAlign = "contentJustify";
         this._TransitionListSkin_VerticalLayout1 = _loc1_;
         BindingManager.executeBindings(this,"_TransitionListSkin_VerticalLayout1",this._TransitionListSkin_VerticalLayout1);
         return _loc1_;
      }
      ...
      private function _TransitionListSkin_bindingsSetup() : Array
      {
         ...
         {
            return hostComponent.dataProvider.length + 1;
         },null,"_TransitionListSkin_VerticalLayout1.requestedRowCount");
         return result;
      }
