package anifire.components.skins
{
   ...
   public class BorderlessListSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function BorderlessListSkin()
      {
         super();
         mx_internal::_document = this;
         this.minWidth = 112;
         this.blendMode = "normal";
         this.mxmlContent = [this._BorderlessListSkin_Scroller1_i()];
         this.currentState = "normal";
         this._BorderlessListSkin_ClassFactory1_i();
         states = [new State({
            "name":"normal",
            "overrides":[]
         }),new State({
      ...
      private function _BorderlessListSkin_ClassFactory1_i() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = BorderlessListSkinInnerClass0;
      ...
      private function _BorderlessListSkin_Scroller1_i() : Scroller
      {
         ...
         _loc1_.minHeight = 0;
         _loc1_.viewport = this._BorderlessListSkin_DataGroup1_i();
         _loc1_.id = "scroller";
         if(!_loc1_.document)
         {
      ...
      private function _BorderlessListSkin_DataGroup1_i() : DataGroup
      {
         var _loc1_:DataGroup = new DataGroup();
         _loc1_.itemRenderer = this._BorderlessListSkin_ClassFactory2_c();
         _loc1_.layout = this._BorderlessListSkin_VerticalLayout1_c();
         _loc1_.id = "dataGroup";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _BorderlessListSkin_ClassFactory2_c() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
      ...
      private function _BorderlessListSkin_VerticalLayout1_c() : VerticalLayout
      {
