package anifire.components.skins
{
   ...
   public class ToggleButtonBarSkinInnerClass0 extends ButtonBarButton
   {
      ...
      public function ToggleButtonBarSkinInnerClass0()
      {
         super();
      }
      ...
      override public function set moduleFactory(param1:IFlexModuleFactory) : void
      {
         ...
         {
            this.skinClass = ToggleButtonBarFirstButtonSkin;
         };
      }
