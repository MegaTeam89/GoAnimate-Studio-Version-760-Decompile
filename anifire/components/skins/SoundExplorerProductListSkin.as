package anifire.components.skins
{
   ...
   public class SoundExplorerProductListSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function SoundExplorerProductListSkin()
      {
         ...
         this.mxmlContent = [this._SoundExplorerProductListSkin_Rect1_i(),this._SoundExplorerProductListSkin_Scroller1_i(),this._SoundExplorerProductListSkin_Rect2_c()];
      ...
      private function _SoundExplorerProductListSkin_Rect2_c() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.bottom = 0;
         _loc1_.height = 8;
         _loc1_.left = 0;
         _loc1_.right = 16;
         _loc1_.fill = this._SoundExplorerProductListSkin_LinearGradient1_c();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _SoundExplorerProductListSkin_LinearGradient1_c() : LinearGradient
      {
         var _loc1_:LinearGradient = new LinearGradient();
         _loc1_.rotation = 90;
         _loc1_.entries = [this._SoundExplorerProductListSkin_GradientEntry1_c(),this._SoundExplorerProductListSkin_GradientEntry2_c()];
         return _loc1_;
      }
      
      private function _SoundExplorerProductListSkin_GradientEntry1_c() : GradientEntry
      {
      ...
      private function _SoundExplorerProductListSkin_GradientEntry2_c() : GradientEntry
      {
         var _loc1_:GradientEntry = new GradientEntry();
         _loc1_.color = 16777215;
         _loc1_.alpha = 1;
