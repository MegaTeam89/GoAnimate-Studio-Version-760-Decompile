package anifire.components.skins
{
   ...
   public class ButtonDropDownOpenButtonSkin extends SparkSkin implements IStateClient2
   {
      ...
      private var _1339719395_ButtonDropDownOpenButtonSkin_SolidColorStroke1:SolidColorStroke;
      ...
      public function ButtonDropDownOpenButtonSkin()
      {
         ...
         states = [new State({
            ...
            "overrides":[new SetProperty().initializeFromObject({
               "target":"_ButtonDropDownOpenButtonSkin_SolidColorStroke1",
               "name":"color",
               "value":16742400
      ...
      private function _ButtonDropDownOpenButtonSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.bottomRightRadiusY = 4;
         _loc1_.fill = this._ButtonDropDownOpenButtonSkin_LinearGradient1_c();
         _loc1_.stroke = this._ButtonDropDownOpenButtonSkin_SolidColorStroke1_i();
      ...
      private function _ButtonDropDownOpenButtonSkin_LinearGradient1_c() : LinearGradient
      {
         var _loc1_:LinearGradient = new LinearGradient();
         _loc1_.rotation = 90;
         _loc1_.entries = [this._ButtonDropDownOpenButtonSkin_GradientEntry1_c(),this._ButtonDropDownOpenButtonSkin_GradientEntry2_c()];
         return _loc1_;
      }
      
      private function _ButtonDropDownOpenButtonSkin_GradientEntry1_c() : GradientEntry
      {
      ...
      private function _ButtonDropDownOpenButtonSkin_GradientEntry2_c() : GradientEntry
      {
         var _loc1_:GradientEntry = new GradientEntry();
      ...
      private function _ButtonDropDownOpenButtonSkin_SolidColorStroke1_i() : SolidColorStroke
      {
         var _loc1_:SolidColorStroke = new SolidColorStroke();
         _loc1_.alpha = 0.7;
         _loc1_.color = 6119264;
         this._ButtonDropDownOpenButtonSkin_SolidColorStroke1 = _loc1_;
         BindingManager.executeBindings(this,"_ButtonDropDownOpenButtonSkin_SolidColorStroke1",this._ButtonDropDownOpenButtonSkin_SolidColorStroke1);
         return _loc1_;
      }
      ...
      private function _ButtonDropDownOpenButtonSkin_Path1_i() : Path
      {
         ...
         _loc1_.data = "M 0 0 l 10 0 l -5 5 z";
      ...
      [Bindable(event="propertyChange")]
      public function get _ButtonDropDownOpenButtonSkin_SolidColorStroke1() : SolidColorStroke
      {
         return this._1339719395_ButtonDropDownOpenButtonSkin_SolidColorStroke1;
      }
      
      public function set _ButtonDropDownOpenButtonSkin_SolidColorStroke1(param1:SolidColorStroke) : void
      {
         var _loc2_:Object = this._1339719395_ButtonDropDownOpenButtonSkin_SolidColorStroke1;
         if(_loc2_ !== param1)
         {
            this._1339719395_ButtonDropDownOpenButtonSkin_SolidColorStroke1 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_ButtonDropDownOpenButtonSkin_SolidColorStroke1",_loc2_,param1));
            }
         }
      }
