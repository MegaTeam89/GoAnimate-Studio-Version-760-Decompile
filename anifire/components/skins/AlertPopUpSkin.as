package anifire.components.skins
{
   ...
   public class AlertPopUpSkin extends Skin implements IBindingClient, IStateClient2
   {
      
      private static var _watcherSetupUtil:IWatcherSetupUtil2;
       
      
      public var _AlertPopUpSkin_Fade1:Fade;
      
      public var _AlertPopUpSkin_Fade2:Fade;
      
      public var _AlertPopUpSkin_Fade3:Fade;
      
      public var _AlertPopUpSkin_Fade4:Fade;
      ...
      private var _213507019hostComponent:AlertPopUp;
      
      public function AlertPopUpSkin()
      {
         ...
         bindings = this._AlertPopUpSkin_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_components_skins_AlertPopUpSkinWatcherSetupUtil");
         ...
         {
            return AlertPopUpSkin[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.transitions = [this._AlertPopUpSkin_Transition1_c(),this._AlertPopUpSkin_Transition2_c(),this._AlertPopUpSkin_Transition3_c(),this._AlertPopUpSkin_Transition4_c()];
         this.mxmlContent = [this._AlertPopUpSkin_Group1_i()];
      ...
      {
         AlertPopUpSkin._watcherSetupUtil = param1;
      }
      ...
      private function _AlertPopUpSkin_Transition1_c() : Transition
      {
         var _loc1_:Transition = new Transition();
         _loc1_.fromState = "closed";
         _loc1_.toState = "normal";
         _loc1_.autoReverse = true;
         _loc1_.effect = this._AlertPopUpSkin_Fade1_i();
         return _loc1_;
      }
      
      private function _AlertPopUpSkin_Fade1_i() : Fade
      {
         var _loc1_:Fade = new Fade();
         _loc1_.duration = 150;
         this._AlertPopUpSkin_Fade1 = _loc1_;
         BindingManager.executeBindings(this,"_AlertPopUpSkin_Fade1",this._AlertPopUpSkin_Fade1);
         return _loc1_;
      }
      
      private function _AlertPopUpSkin_Transition2_c() : Transition
      {
         var _loc1_:Transition = new Transition();
         _loc1_.fromState = "disabledAndClosed";
         _loc1_.toState = "disabled";
         _loc1_.autoReverse = true;
         _loc1_.effect = this._AlertPopUpSkin_Fade2_i();
         return _loc1_;
      }
      
      private function _AlertPopUpSkin_Fade2_i() : Fade
      {
         var _loc1_:Fade = new Fade();
         _loc1_.duration = 150;
         this._AlertPopUpSkin_Fade2 = _loc1_;
         BindingManager.executeBindings(this,"_AlertPopUpSkin_Fade2",this._AlertPopUpSkin_Fade2);
         return _loc1_;
      }
      
      private function _AlertPopUpSkin_Transition3_c() : Transition
      {
         var _loc1_:Transition = new Transition();
         _loc1_.fromState = "normal";
         _loc1_.toState = "closed";
         _loc1_.autoReverse = true;
         _loc1_.effect = this._AlertPopUpSkin_Fade3_i();
         return _loc1_;
      }
      
      private function _AlertPopUpSkin_Fade3_i() : Fade
      {
         var _loc1_:Fade = new Fade();
         _loc1_.duration = 150;
         this._AlertPopUpSkin_Fade3 = _loc1_;
         BindingManager.executeBindings(this,"_AlertPopUpSkin_Fade3",this._AlertPopUpSkin_Fade3);
         return _loc1_;
      }
      
      private function _AlertPopUpSkin_Transition4_c() : Transition
      {
         var _loc1_:Transition = new Transition();
         _loc1_.fromState = "disabled";
         _loc1_.toState = "disabledAndClosed";
         _loc1_.autoReverse = true;
         _loc1_.effect = this._AlertPopUpSkin_Fade4_i();
         return _loc1_;
      }
      
      private function _AlertPopUpSkin_Fade4_i() : Fade
      {
         var _loc1_:Fade = new Fade();
         _loc1_.duration = 150;
         this._AlertPopUpSkin_Fade4 = _loc1_;
         BindingManager.executeBindings(this,"_AlertPopUpSkin_Fade4",this._AlertPopUpSkin_Fade4);
         return _loc1_;
      }
      
      private function _AlertPopUpSkin_Group1_i() : Group
      {
         ...
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.mxmlContent = [this._AlertPopUpSkin_Group2_i()];
         _loc1_.id = "chrome";
         if(!_loc1_.document)
         {
      ...
      private function _AlertPopUpSkin_Group2_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.left = 0;
         _loc1_.right = 0;
         ...
         _loc1_.minWidth = 0;
         _loc1_.minHeight = 0;
         _loc1_.mxmlContent = [this._AlertPopUpSkin_Group3_i()];
      ...
      private function _AlertPopUpSkin_Group3_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.horizontalCenter = 0;
         _loc1_.top = 200;
         _loc1_.mxmlContent = [this._AlertPopUpSkin_Panel1_i(),this._AlertPopUpSkin_IconButton1_i()];
      ...
      private function _AlertPopUpSkin_Panel1_i() : Panel
      {
         var _loc1_:Panel = new Panel();
         _loc1_.minWidth = 200;
         _loc1_.maxWidth = 400;
         _loc1_.layout = this._AlertPopUpSkin_VerticalLayout1_c();
         _loc1_.controlBarContent = [this._AlertPopUpSkin_Button1_i(),this._AlertPopUpSkin_Button2_i()];
         _loc1_.controlBarLayout = this._AlertPopUpSkin_HorizontalLayout1_c();
         _loc1_.mxmlContentFactory = new DeferredInstanceFromFunction(this._AlertPopUpSkin_Array10_c);
      ...
      private function _AlertPopUpSkin_VerticalLayout1_c() : VerticalLayout
      {
      ...
      private function _AlertPopUpSkin_Button1_i() : Button
      {
      ...
      private function _AlertPopUpSkin_Button2_i() : Button
      {
         var _loc1_:Button = new Button();
         _loc1_.buttonMode = true;
         _loc1_.height = 32;
      ...
      private function _AlertPopUpSkin_HorizontalLayout1_c() : HorizontalLayout
      {
      ...
      private function _AlertPopUpSkin_Array10_c() : Array
      {
         return [this._AlertPopUpSkin_Label1_i()];
      }
      
      private function _AlertPopUpSkin_Label1_i() : Label
      {
      ...
      private function _AlertPopUpSkin_IconButton1_i() : IconButton
      {
      ...
      private function _AlertPopUpSkin_bindingsSetup() : Array
      {
         var _loc1_:Array = [];
         _loc1_[0] = new Binding(this,null,null,"_AlertPopUpSkin_Fade1.target","chrome");
         _loc1_[1] = new Binding(this,null,null,"_AlertPopUpSkin_Fade2.target","chrome");
         _loc1_[2] = new Binding(this,null,null,"_AlertPopUpSkin_Fade3.target","chrome");
         _loc1_[3] = new Binding(this,null,null,"_AlertPopUpSkin_Fade4.target","chrome");
         return _loc1_;
      }
      ...
      [Bindable(event="propertyChange")]
      public function get hostComponent() : AlertPopUp
      {
         return this._213507019hostComponent;
      }
      
      public function set hostComponent(param1:AlertPopUp) : void
      {
