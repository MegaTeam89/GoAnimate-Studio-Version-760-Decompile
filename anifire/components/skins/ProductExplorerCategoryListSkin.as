...
{
   import anifire.components.studio.ProductExplorerCategoryRenderer;
   ...
   public class ProductExplorerCategoryListSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function ProductExplorerCategoryListSkin()
      {
         ...
         this._ProductExplorerCategoryListSkin_ClassFactory1_i();
         states = [new State({
            "name":"normal",
            "overrides":[]
         }),new State({
      ...
      private function _ProductExplorerCategoryListSkin_ClassFactory1_i() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = ProductExplorerCategoryListSkinInnerClass0;
      ...
      private function _ProductExplorerCategoryListSkin_DataGroup1_i() : DataGroup
      {
         ...
         _loc1_.itemRenderer = this._ProductExplorerCategoryListSkin_ClassFactory2_c();
      ...
      private function _ProductExplorerCategoryListSkin_ClassFactory2_c() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
