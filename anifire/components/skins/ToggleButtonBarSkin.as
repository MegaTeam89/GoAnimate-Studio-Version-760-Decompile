package anifire.components.skins
{
   ...
   public class ToggleButtonBarSkin extends Skin implements IStateClient2
   {
      ...
      public function ToggleButtonBarSkin()
      {
         super();
         mx_internal::_document = this;
         this.minHeight = 25;
         this.mxmlContent = [this._ToggleButtonBarSkin_DataGroup1_i()];
         this.currentState = "normal";
         this._ToggleButtonBarSkin_ClassFactory1_i();
         this._ToggleButtonBarSkin_ClassFactory3_i();
         this._ToggleButtonBarSkin_ClassFactory2_i();
         states = [new State({
            "name":"normal",
            "overrides":[]
         }),new State({
      ...
      private function _ToggleButtonBarSkin_ClassFactory1_i() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = ToggleButtonBarSkinInnerClass0;
      ...
      private function _ToggleButtonBarSkin_ClassFactory3_i() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = ToggleButtonBarSkinInnerClass2;
         _loc1_.properties = {"outerDocument":this};
      ...
      private function _ToggleButtonBarSkin_ClassFactory2_i() : ClassFactory
      {
         var _loc1_:ClassFactory = new ClassFactory();
         _loc1_.generator = ToggleButtonBarSkinInnerClass1;
         _loc1_.properties = {"outerDocument":this};
      ...
      private function _ToggleButtonBarSkin_DataGroup1_i() : DataGroup
      {
         var _loc1_:DataGroup = new DataGroup();
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.layout = this._ToggleButtonBarSkin_ButtonBarHorizontalLayout1_c();
         _loc1_.id = "dataGroup";
         if(!_loc1_.document)
         {
      ...
      private function _ToggleButtonBarSkin_ButtonBarHorizontalLayout1_c() : ButtonBarHorizontalLayout
      {
