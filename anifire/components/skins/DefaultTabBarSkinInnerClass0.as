package anifire.components.skins
{
   ...
   public class DefaultTabBarSkinInnerClass0 extends ButtonBarButton implements IBindingClient
   {
      ...
      public function DefaultTabBarSkinInnerClass0()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_components_skins_DefaultTabBarSkinInnerClass0WatcherSetupUtil");
      ...
      override public function set moduleFactory(param1:IFlexModuleFactory) : void
      {
         ...
         {
            this.skinClass = DefaultButtonBarButtonSkin;
         };
      }
