package anifire.components.skins
{
   ...
   public class ToggleButtonBarSkinInnerClass1 extends ButtonBarButton
   {
      ...
      public function ToggleButtonBarSkinInnerClass1()
      {
         super();
      }
      ...
      override public function set moduleFactory(param1:IFlexModuleFactory) : void
      {
         ...
         {
            this.skinClass = ToggleButtonBarMiddleButtonSkin;
         };
      }
