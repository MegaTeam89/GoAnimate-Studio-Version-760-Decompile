...
{
   import anifire.components.studio.LanguageIcon;
   ...
   public class LanguageDropDownListSkin extends SparkSkin implements IBindingClient, IStateClient2
   {
      ...
      public function LanguageDropDownListSkin()
      {
         ...
         bindings = this._LanguageDropDownListSkin_bindingsSetup();
         var watchers:Array = [];
         target = this;
         if(_watcherSetupUtil == null)
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_components_skins_LanguageDropDownListSkinWatcherSetupUtil");
         ...
         {
            return LanguageDropDownListSkin[param1];
         },bindings,watchers);
         mx_internal::_bindings = mx_internal::_bindings.concat(bindings);
         mx_internal::_watchers = mx_internal::_watchers.concat(watchers);
         this.mxmlContent = [this._LanguageDropDownListSkin_Button1_i(),this._LanguageDropDownListSkin_HGroup1_i()];
         this.currentState = "normal";
         var _LanguageDropDownListSkin_PopUpAnchor1_factory:DeferredInstanceFromFunction = new DeferredInstanceFromFunction(this._LanguageDropDownListSkin_PopUpAnchor1_i,this._LanguageDropDownListSkin_PopUpAnchor1_r);
         states = [new State({
            "name":"normal",
            ...
            "overrides":[new AddItems().initializeFromObject({
               ...
               "itemsFactory":_LanguageDropDownListSkin_PopUpAnchor1_factory,
               "destination":null,
      ...
      {
         LanguageDropDownListSkin._watcherSetupUtil = param1;
      }
      ...
      protected function getIconName(param1:Object) : String
      {
         var _loc2_:VoiceModel = null;
         if(param1 is VoiceModel)
         {
            _loc2_ = param1 as VoiceModel;
            return _loc2_.iconName;
         }
         return null;
      }
      
      private function _LanguageDropDownListSkin_PopUpAnchor1_i() : PopUpAnchor
      {
         ...
         _loc1_.popUp = this._LanguageDropDownListSkin_Group1_i();
         _loc1_.id = "popUp";
         if(!_loc1_.document)
         {
      ...
      private function _LanguageDropDownListSkin_PopUpAnchor1_r() : void
      {
         this.popUp = null;
         this.dropDown = null;
      ...
      private function _LanguageDropDownListSkin_Group1_i() : Group
      {
         var _loc1_:Group = new Group();
         _loc1_.mxmlContent = [this._LanguageDropDownListSkin_RectangularDropShadow1_i(),this._LanguageDropDownListSkin_Rect1_i(),this._LanguageDropDownListSkin_Rect2_i(),this._LanguageDropDownListSkin_Scroller1_i()];
         _loc1_.id = "dropDown";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _LanguageDropDownListSkin_RectangularDropShadow1_i() : RectangularDropShadow
      {
      ...
      private function _LanguageDropDownListSkin_Rect1_i() : Rect
      {
         ...
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.stroke = this._LanguageDropDownListSkin_SolidColorStroke1_i();
      ...
      private function _LanguageDropDownListSkin_SolidColorStroke1_i() : SolidColorStroke
      {
      ...
      private function _LanguageDropDownListSkin_Rect2_i() : Rect
      {
         var _loc1_:Rect = new Rect();
         _loc1_.left = 1;
         _loc1_.right = 1;
         _loc1_.top = 1;
         _loc1_.bottom = 1;
         _loc1_.fill = this._LanguageDropDownListSkin_SolidColor1_i();
      ...
      private function _LanguageDropDownListSkin_SolidColor1_i() : SolidColor
      {
      ...
      private function _LanguageDropDownListSkin_Scroller1_i() : Scroller
      {
         ...
         _loc1_.viewport = this._LanguageDropDownListSkin_DataGroup1_i();
         _loc1_.id = "scroller";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _LanguageDropDownListSkin_DataGroup1_i() : DataGroup
      {
         var _loc1_:DataGroup = new DataGroup();
         _loc1_.itemRenderer = this._LanguageDropDownListSkin_ClassFactory1_c();
         _loc1_.layout = this._LanguageDropDownListSkin_VerticalLayout1_c();
         _loc1_.id = "dataGroup";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
      ...
      private function _LanguageDropDownListSkin_ClassFactory1_c() : ClassFactory
      {
      ...
      private function _LanguageDropDownListSkin_VerticalLayout1_c() : VerticalLayout
      {
         ...
         _loc1_.requestedMaxRowCount = 8;
         return _loc1_;
      }
      
      private function _LanguageDropDownListSkin_Button1_i() : Button
      {
      ...
      private function _LanguageDropDownListSkin_HGroup1_i() : HGroup
      {
         ...
         _loc1_.mxmlContent = [this._LanguageDropDownListSkin_LanguageIcon1_i(),this._LanguageDropDownListSkin_Label1_i()];
      ...
      private function _LanguageDropDownListSkin_LanguageIcon1_i() : LanguageIcon
      {
      ...
      private function _LanguageDropDownListSkin_Label1_i() : Label
      {
      ...
      private function _LanguageDropDownListSkin_bindingsSetup() : Array
      {
         var result:Array = [];
         result[0] = new Binding(this,function():String
         {
            var _loc1_:* = getIconName(hostComponent.selectedItem);
            return _loc1_ == undefined ? null : String(_loc1_);
         },null,"flagDisplay.iconName");
         return result;
      }
