package anifire.components.skins
{
   ...
   public class DefaultVScrollBarSkin extends SparkSkin implements IStateClient2
   {
      ...
      public function DefaultVScrollBarSkin()
      {
         super();
         mx_internal::_document = this;
         this.minWidth = 15;
         this.minHeight = 35;
         this.mxmlContent = [this._DefaultVScrollBarSkin_Button1_i(),this._DefaultVScrollBarSkin_Button2_i()];
      ...
      private function _DefaultVScrollBarSkin_Button1_i() : Button
      {
         ...
         _loc1_.setStyle("skinClass",DefaultVScrollBarTrackSkin);
         _loc1_.id = "track";
         if(!_loc1_.document)
         {
      ...
      private function _DefaultVScrollBarSkin_Button2_i() : Button
      {
         var _loc1_:Button = new Button();
         _loc1_.focusEnabled = false;
         _loc1_.tabEnabled = false;
         _loc1_.setStyle("skinClass",DefaultVScrollBarThumbSkin);
         _loc1_.id = "thumb";
         if(!_loc1_.document)
         {
            _loc1_.document = this;
