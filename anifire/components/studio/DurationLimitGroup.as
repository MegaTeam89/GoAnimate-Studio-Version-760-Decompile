package anifire.components.studio
{
   ...
   public class DurationLimitGroup extends Group
   {
      ...
      protected function init() : void
      {
         ...
         var _loc2_:String = UtilDict.toDisplay("go","As a free user, you can only make videos up to 2 minutes in length. Please either shorten this video or {0} to publish.");
         ...
         (_loc7_ = new SpanElement()).text = UtilDict.toDisplay("go","upgrade now");
