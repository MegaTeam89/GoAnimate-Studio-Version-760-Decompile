package anifire.components.studio
{
   ...
   public class PreviewSaveGroup extends Group
   {
      ...
      protected function init() : void
      {
         ...
         var _loc2_:String = UtilDict.toDisplay("go","We hope you enjoy this preview of the {1} theme. Please {0} to a business plan to save your video.");
         _loc2_ = _loc2_.replace("{1}",Console.getConsole().currentLicensorName);
         var _loc3_:Array = _loc2_.split("{0}");
         var _loc4_:ParagraphElement = new ParagraphElement();
         var _loc5_:SpanElement;
         (_loc5_ = new SpanElement()).text = _loc3_[0];
         _loc4_.addChild(_loc5_);
         var _loc6_:LinkElement = new LinkElement();
         var _loc7_:SpanElement;
         (_loc7_ = new SpanElement()).text = UtilDict.toDisplay("go","upgrade");
      ...
      {
         UtilNavigate.toBusinessPlanPage("","wndbizplan");
