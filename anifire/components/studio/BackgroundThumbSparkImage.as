package anifire.components.studio
{
   ...
   public class BackgroundThumbSparkImage extends ThumbImageBase implements IStateClient2
   {
      ...
      public function BackgroundThumbSparkImage()
      {
         ...
         this.addEventListener("resize",this.___BackgroundThumbSparkImage_ThumbImageBase1_resize);
      ...
      protected function onImageLoaderInit(param1:Event = null) : void
      {
         ...
         if(_product.themeId != "ugc" && this._loader.content is DisplayObject)
         {
      ...
      public function ___BackgroundThumbSparkImage_ThumbImageBase1_resize(param1:ResizeEvent) : void
      {
         this.onResize();
      }
