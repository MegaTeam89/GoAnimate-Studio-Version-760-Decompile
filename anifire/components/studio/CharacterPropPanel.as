...
{
   import anifire.command.ChangePropStateCommand;
   ...
   public class CharacterPropPanel extends Group implements IBindingClient
   {
      ...
      private var _819188908propStateList:DropDownList;
      ...
      private var _30941675popUpPosition:String = "above";
      ...
      public function CharacterPropPanel()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_components_studio_CharacterPropPanelWatcherSetupUtil");
         ...
         this.mxmlContent = [this._CharacterPropPanel_HGroup1_c(),this._CharacterPropPanel_Line2_c(),this._CharacterPropPanel_Line3_c(),this._CharacterPropPanel_Line4_c()];
         var i:uint = 0;
      ...
      private function createMenuModel(param1:XML) : void
      {
         ...
         {
            if((_loc5_ = _loc2_.states[_loc4_] as State).isEnable)
            {
      ...
      private function _CharacterPropPanel_Group2_i() : Group
      {
         ...
         _loc1_.mxmlContent = [this._CharacterPropPanel_Rect1_c(),this._CharacterPropPanel_HGroup2_c()];
      ...
      private function _CharacterPropPanel_Group3_i() : Group
      {
         ...
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.mxmlContent = [this._CharacterPropPanel_Line1_c(),this._CharacterPropPanel_Group4_c()];
      ...
      private function _CharacterPropPanel_DropDownList1_i() : DropDownList
      {
      ...
      private function _CharacterPropPanel_Line4_c() : Line
      {
         var _loc1_:Line = new Line();
         _loc1_.bottom = 0;
         _loc1_.left = 1;
         _loc1_.right = 1;
         _loc1_.stroke = this._CharacterPropPanel_SolidColorStroke4_c();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _CharacterPropPanel_SolidColorStroke4_c() : SolidColorStroke
      {
         var _loc1_:SolidColorStroke = new SolidColorStroke();
         _loc1_.color = 11649221;
         return _loc1_;
      ...
      private function _CharacterPropPanel_bindingsSetup() : Array
      {
         ...
         result[3] = new Binding(this,null,null,"propStateList.popUpPosition","popUpPosition");
      ...
      [Bindable(event="propertyChange")]
      public function get propStateList() : DropDownList
      {
         return this._819188908propStateList;
      }
      
      public function set propStateList(param1:DropDownList) : void
      {
