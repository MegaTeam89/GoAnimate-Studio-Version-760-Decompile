...
{
   import anifire.components.skins.CloseTrayButtonSkin;
   ...
   public class OverTray extends Group implements IBindingClient, IStateClient2
   {
      ...
      private function _OverTray_Group2_i() : Group
      {
         ...
         _loc1_.mxmlContent = [this._OverTray_HGroup1_i()];
         _loc1_.id = "clipGroup";
         if(!_loc1_.document)
         {
      ...
      private function _OverTray_HGroup1_i() : HGroup
      {
         ...
         _loc1_.gap = 0;
         _loc1_.mxmlContent = [this._OverTray_PropertiesWindow1_i(),this._OverTray_Button1_i(),this._OverTray_Spacer1_c()];
      ...
      private function _OverTray_Spacer1_c() : Spacer
      {
