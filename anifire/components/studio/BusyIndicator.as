package anifire.components.studio
{
   ...
   public class BusyIndicator extends UIComponent
   {
      ...
      mx_internal function drawSpinner() : void
      {
         ...
         var _loc6_:Number;
         var _loc5_:Number;
         var _loc7_:Number = (_loc6_ = (_loc5_ = this.spinnerDiameter - _loc4_ * 2) / 5) / 2;
         var _loc8_:Number = 0;
         _loc1_.clear();
      ...
      {
         var _loc9_:Graphics;
         (_loc9_ = graphics).lineStyle(param3,param5,param1,false,LineScaleMode.NORMAL,CapsStyle.ROUND);
