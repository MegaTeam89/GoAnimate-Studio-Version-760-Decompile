package anifire.components.studio
{
   ...
   public class EffectThumbRenderer extends ThumbRendererBase implements IBindingClient, IStateClient2
   {
      ...
      private var _1457339357_EffectThumbRenderer_SolidColor1:SolidColor;
      ...
      public function EffectThumbRenderer()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_components_studio_EffectThumbRendererWatcherSetupUtil");
         ...
         this.width = 60;
         this.height = 60;
         this.mxmlContent = [this._EffectThumbRenderer_Rect1_c(),this._EffectThumbRenderer_EffectThumbSparkImage1_i()];
         ...
         states = [new State({
            ...
            "overrides":[new AddItems().initializeFromObject({
               ...
               "target":"_EffectThumbRenderer_SolidColor1",
               "name":"color",
               "value":13292248
            })]
         }),new State({
      ...
      private function _EffectThumbRenderer_Rect1_c() : Rect
      {
         ...
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.fill = this._EffectThumbRenderer_SolidColor1_i();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _EffectThumbRenderer_SolidColor1_i() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         _loc1_.color = 15987700;
         this._EffectThumbRenderer_SolidColor1 = _loc1_;
         BindingManager.executeBindings(this,"_EffectThumbRenderer_SolidColor1",this._EffectThumbRenderer_SolidColor1);
         return _loc1_;
      }
      ...
      public function get _EffectThumbRenderer_SolidColor1() : SolidColor
      {
         return this._1457339357_EffectThumbRenderer_SolidColor1;
      }
      
      public function set _EffectThumbRenderer_SolidColor1(param1:SolidColor) : void
      {
         var _loc2_:Object = this._1457339357_EffectThumbRenderer_SolidColor1;
         if(_loc2_ !== param1)
         {
            this._1457339357_EffectThumbRenderer_SolidColor1 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_EffectThumbRenderer_SolidColor1",_loc2_,param1));
            }
         }
      }
