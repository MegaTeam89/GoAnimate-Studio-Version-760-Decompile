package anifire.components.studio
{
   ...
   import anifire.command.ChangeFacialExpressionCommand;
   import anifire.command.ICommand;
   import anifire.components.skins.ClearCharacterActionButtonSkin;
   import anifire.components.skins.ExpressionDropDownListSkin;
   import anifire.components.skins.LookAtCameraToggleButtonSkin;
   ...
   public class CharacterExpressionPanel extends Group implements IBindingClient
   {
      ...
      public function CharacterExpressionPanel()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_components_studio_CharacterExpressionPanelWatcherSetupUtil");
         ...
         this.mxmlContent = [this._CharacterExpressionPanel_HGroup1_c(),this._CharacterExpressionPanel_Line2_c(),this._CharacterExpressionPanel_Line3_c(),this._CharacterExpressionPanel_Line4_c()];
         var i:uint = 0;
      ...
      private function createMenuModel(param1:CharThumb) : void
      {
         ...
         if(this._autoStateId)
         {
            this.autoFaceModel.updateAutoState(this._autoStateId);
         }
         ...
         var _loc4_:MenuItemModel;
         (_loc4_ = new MenuItemModel("",null,MenuItemModel.MENU_TYPE_SEPARATOR)).sortOrder = -1;
         ...
         var _loc6_:Sort;
         (_loc6_ = new Sort()).fields = [new SortField("sortOrder",false,true),new SortField("label")];
      ...
      private function _CharacterExpressionPanel_Group2_i() : Group
      {
         ...
         _loc1_.mxmlContent = [this._CharacterExpressionPanel_Rect1_c(),this._CharacterExpressionPanel_HGroup2_c()];
      ...
      private function _CharacterExpressionPanel_Group3_i() : Group
      {
         ...
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.mxmlContent = [this._CharacterExpressionPanel_Line1_c(),this._CharacterExpressionPanel_HGroup3_c()];
      ...
      private function _CharacterExpressionPanel_Line4_c() : Line
      {
         var _loc1_:Line = new Line();
         _loc1_.bottom = 0;
         _loc1_.left = 1;
         _loc1_.right = 1;
         _loc1_.stroke = this._CharacterExpressionPanel_SolidColorStroke4_c();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _CharacterExpressionPanel_SolidColorStroke4_c() : SolidColorStroke
      {
         var _loc1_:SolidColorStroke = new SolidColorStroke();
         _loc1_.color = 11649221;
         return _loc1_;
