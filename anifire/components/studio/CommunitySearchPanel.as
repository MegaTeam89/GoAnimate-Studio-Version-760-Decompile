package anifire.components.studio
{
   ...
   import anifire.models.CommunitySearchGroupCollection;
   ...
   public class CommunitySearchPanel extends NavigatorContent implements IBindingClient
   {
      ...
      private var _572090789resultList:ProductCategoryList;
      ...
      public function CommunitySearchPanel()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_components_studio_CommunitySearchPanelWatcherSetupUtil");
      ...
      private function init() : void
      {
         ...
         this.resultList.hideAllCategories();
      ...
      private function search(param1:String) : void
      {
         ...
         this.resultList.closeAllCategories();
      ...
      public function onSearchComplete(param1:CoreEvent) : void
      {
         ...
         this._resultCountText = StringUtil.substitute(UtilDict.toDisplay("go","{0} asset(s) found."),param1.getData());
      }
      ...
      private function onSearchDataReady(param1:CoreEvent) : void
      {
         ...
         while(_loc6_ < _loc3_)
         {
            if((_loc4_ = this.manager.searchResults.getItemAt(_loc6_) as Thumb).enable)
            {
         ...
         this.resultList.expandAllCategories();
         this._loading = false;
      }
      ...
      {
         return [this._CommunitySearchPanel_VGroup1_c(),this._CommunitySearchPanel_ProductCategoryList1_i()];
      }
      ...
      private function _CommunitySearchPanel_ProductCategoryList1_i() : ProductCategoryList
      {
         var _loc1_:ProductCategoryList = new ProductCategoryList();
         _loc1_.percentWidth = 100;
         _loc1_.percentHeight = 100;
         _loc1_.allowInteraction = false;
      ...
      [Bindable(event="propertyChange")]
      public function get resultList() : ProductCategoryList
      {
         return this._572090789resultList;
      }
      
      public function set resultList(param1:ProductCategoryList) : void
      {
