...
{
   import anifire.components.skins.SearchTextInputSkin;
   ...
   public class CommunityPanel extends NavigatorContent implements IBindingClient
   {
      
      private static var _watcherSetupUtil:IWatcherSetupUtil2;
       
      
      private var _1298714998backgroundPanel:NavigatorContent;
      
      private var _342683739characterPanel:NavigatorContent;
      ...
      private var _742515615propPanel:NavigatorContent;
      ...
      public function CommunityPanel()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_components_studio_CommunityPanelWatcherSetupUtil");
      ...
      {
         return [this._CommunityPanel_TabBar1_i(),this._CommunityPanel_Group1_c()];
      }
      ...
      private function _CommunityPanel_Group1_c() : Group
      {
         ...
         _loc1_.mxmlContent = [this._CommunityPanel_VGroup1_c(),this._CommunityPanel_Line1_c()];
         if(!_loc1_.document)
         {
            _loc1_.document = this;
         }
      ...
      {
         return [this._CommunityPanel_DecoratedList1_i()];
      }
      ...
      private function _CommunityPanel_DecoratedList1_i() : DecoratedList
      {
         ...
         _loc1_.layout = this._CommunityPanel_ViewportTileLayout1_c();
      ...
      private function _CommunityPanel_ViewportTileLayout1_c() : ViewportTileLayout
      {
      ...
      {
         return [this._CommunityPanel_DecoratedList2_i()];
      }
      ...
      private function _CommunityPanel_DecoratedList2_i() : DecoratedList
      {
         ...
         _loc1_.layout = this._CommunityPanel_ViewportTileLayout2_c();
      ...
      private function _CommunityPanel_ViewportTileLayout2_c() : ViewportTileLayout
      {
         var _loc1_:ViewportTileLayout = new ViewportTileLayout();
      ...
      {
         return [this._CommunityPanel_DecoratedList3_i()];
      }
      ...
      private function _CommunityPanel_DecoratedList3_i() : DecoratedList
      {
         ...
         _loc1_.layout = this._CommunityPanel_ViewportTileLayout3_c();
      ...
      private function _CommunityPanel_ViewportTileLayout3_c() : ViewportTileLayout
      {
         var _loc1_:ViewportTileLayout = new ViewportTileLayout();
      ...
      public function get backgroundPanel() : NavigatorContent
      {
         return this._1298714998backgroundPanel;
      }
      
      public function set backgroundPanel(param1:NavigatorContent) : void
      {
      ...
      [Bindable(event="propertyChange")]
      public function get characterPanel() : NavigatorContent
      {
         return this._342683739characterPanel;
      }
      
      public function set characterPanel(param1:NavigatorContent) : void
      {
      ...
      [Bindable(event="propertyChange")]
      public function get propPanel() : NavigatorContent
      {
         return this._742515615propPanel;
      }
      
      public function set propPanel(param1:NavigatorContent) : void
      {
