package anifire.components.studio
{
   ...
   public class ActionThumbSparkImage extends Group implements IBindingClient, IStateClient2
   {
      ...
      public static const THUMB_HEIGHT:Number = 56;
      ...
      public function ActionThumbSparkImage()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_components_studio_ActionThumbSparkImageWatcherSetupUtil");
      ...
      protected function insertProp(param1:XML, param2:String) : void
      {
         ...
         var _loc6_:Theme;
         if(_loc6_ = Theme(ThemeManager.instance.getTheme(param2)))
         {
      ...
      private function addPropByThumb(param1:PropThumb) : void
      {
         ...
         if(param1.holdable == true)
         {
            ...
            else
            {
               ...
               if(_loc3_)
               {
                  if(_loc4_ = UtilPlain.getProp(_loc3_))
                  {
                     if(_loc5_ = param1.imageData as ByteArray)
                     {
                        this._processingProp = true;
      ...
      protected function captureBitmapData() : void
      {
         ...
         if(_loc1_.width > 0 && _loc1_.width < 1000 && _loc1_.height > 0 && _loc1_.height < 1000)
         {
            ...
            (_loc4_ = new BitmapData(_loc1_.width * _loc2_,_loc1_.height * _loc2_,true,0)).draw(this._captureTarget,_loc3_);
