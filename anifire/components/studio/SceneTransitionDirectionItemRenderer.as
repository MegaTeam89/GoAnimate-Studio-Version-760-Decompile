package anifire.components.studio
{
   ...
   public class SceneTransitionDirectionItemRenderer extends ItemRenderer implements IBindingClient, IStateClient2
   {
      ...
      private var _1610338285_SceneTransitionDirectionItemRenderer_SolidColor1:SolidColor;
      ...
      public function SceneTransitionDirectionItemRenderer()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_components_studio_SceneTransitionDirectionItemRendererWatcherSetupUtil");
         ...
         states = [new State({
            ...
            "overrides":[new AddItems().initializeFromObject({
               ...
               "target":"_SceneTransitionDirectionItemRenderer_SolidColor1",
               "name":"color",
               "value":11649221
            })]
         })];
      ...
      private function _SceneTransitionDirectionItemRenderer_Rect1_i() : Rect
      {
         ...
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.fill = this._SceneTransitionDirectionItemRenderer_SolidColor1_i();
      ...
      private function _SceneTransitionDirectionItemRenderer_SolidColor1_i() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         _loc1_.color = 13292248;
         this._SceneTransitionDirectionItemRenderer_SolidColor1 = _loc1_;
         BindingManager.executeBindings(this,"_SceneTransitionDirectionItemRenderer_SolidColor1",this._SceneTransitionDirectionItemRenderer_SolidColor1);
         return _loc1_;
      }
      ...
      public function get _SceneTransitionDirectionItemRenderer_SolidColor1() : SolidColor
      {
         return this._1610338285_SceneTransitionDirectionItemRenderer_SolidColor1;
      }
      
      public function set _SceneTransitionDirectionItemRenderer_SolidColor1(param1:SolidColor) : void
      {
         var _loc2_:Object = this._1610338285_SceneTransitionDirectionItemRenderer_SolidColor1;
         if(_loc2_ !== param1)
         {
            this._1610338285_SceneTransitionDirectionItemRenderer_SolidColor1 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_SceneTransitionDirectionItemRenderer_SolidColor1",_loc2_,param1));
            }
         }
      }
