package anifire.components.studio
{
   ...
   public class BackgroundThumbRenderer extends ThumbRendererBase implements IBindingClient, IStateClient2
   {
      ...
      private var _788318886_BackgroundThumbRenderer_SolidColor1:SolidColor;
      ...
      public function BackgroundThumbRenderer()
      {
         ...
         {
            watcherSetupUtilClass = getDefinitionByName("_anifire_components_studio_BackgroundThumbRendererWatcherSetupUtil");
         ...
         states = [new State({
            ...
            "overrides":[new AddItems().initializeFromObject({
               ...
               "target":"_BackgroundThumbRenderer_SolidColor1",
               "name":"color",
               "value":13292248
            })]
         }),new State({
      ...
      protected function showDeleteDialog() : void
      {
         ...
         _loc1_.title = UtilDict.toDisplay("go","goalert_delbackground");
         _loc1_.message = UtilDict.toDisplay("go","goalert_delbackgroundtext");
      ...
      private function _BackgroundThumbRenderer_Rect1_c() : Rect
      {
         ...
         _loc1_.top = 0;
         _loc1_.bottom = 0;
         _loc1_.fill = this._BackgroundThumbRenderer_SolidColor1_i();
         _loc1_.initialized(this,null);
         return _loc1_;
      }
      
      private function _BackgroundThumbRenderer_SolidColor1_i() : SolidColor
      {
         var _loc1_:SolidColor = new SolidColor();
         _loc1_.color = 15987700;
         this._BackgroundThumbRenderer_SolidColor1 = _loc1_;
         BindingManager.executeBindings(this,"_BackgroundThumbRenderer_SolidColor1",this._BackgroundThumbRenderer_SolidColor1);
         return _loc1_;
      }
      ...
      public function get _BackgroundThumbRenderer_SolidColor1() : SolidColor
      {
         return this._788318886_BackgroundThumbRenderer_SolidColor1;
      }
      
      public function set _BackgroundThumbRenderer_SolidColor1(param1:SolidColor) : void
      {
         var _loc2_:Object = this._788318886_BackgroundThumbRenderer_SolidColor1;
         if(_loc2_ !== param1)
         {
            this._788318886_BackgroundThumbRenderer_SolidColor1 = param1;
            if(this.hasEventListener("propertyChange"))
            {
               this.dispatchEvent(PropertyChangeEvent.createUpdateEvent(this,"_BackgroundThumbRenderer_SolidColor1",_loc2_,param1));
            }
         }
      }
