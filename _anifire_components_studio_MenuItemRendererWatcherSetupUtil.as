package
{
   ...
   public class _anifire_components_studio_MenuItemRendererWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _anifire_components_studio_MenuItemRendererWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         MenuItemRenderer.watcherSetupUtil = new _anifire_components_studio_MenuItemRendererWatcherSetupUtil();
      }
      
      public function setup(param1:Object, param2:Function, param3:Function, param4:Array, param5:Array) : void
      {
         param5[1] = new PropertyWatcher("model",{"propertyChange":true},[param4[1],param4[2],param4[8],param4[9],param4[10],param4[11],param4[12]],param2);
         ...
         param5[9] = new PropertyWatcher("subMenu",{"propertyChange":true},[param4[12]],null);
