   ...
   public dynamic class FlashEff2 extends JUIComponent
   {
      ...
      public function drawTextTable(param1:String, param2:String, param3:Number, param4:Array, param5:Number, param6:Number, param7:Array = null) : Boolean
      {
            ...
            case "chars":
               ...
               while(_loc14_ < _loc17_)
               {
                  ...
                  while(_loc15_ < _loc18_)
                  {
                     ...
                     _loc31_ = (_loc8_ = _loc9_[_loc15_].owner).x + _loc10_[_loc14_].owner.x;
         ...
         while(_loc14_ < _loc25_)
         {
            ...
            if((_loc20_ = this.textField.getLineIndexOfChar(_loc30_.id)) != _loc26_)
            {
               _loc26_ = _loc20_;
      ...
      protected function getCommandsNumber() : Number
      {
         ...
         for(_loc2_ in FlashEff2.eventTypeAsoc)
         {
            _loc1_ += this["_" + _loc2_ + "Commands"].length;
         }
         return _loc1_;
      }
      ...
      protected function filterArray(param1:Array, param2:String, param3:Number, param4:Array) : void
      {
         ...
         else
         {
            ...
            while(_loc8_ < _loc10_)
            {
               ...
               _loc17_ = / /g;
               _loc19_ = (_loc18_ = _loc14_.replace(_loc17_,"")).length;
               while(_loc15_ != -1)
               {
                  _loc20_ = _loc15_;
      ...
      protected function wordsSplit(param1:String, param2:uint) : Array
      {
         ...
         while(_loc8_ < _loc5_)
         {
            ...
            {
               _loc10_ = true;
               if((_loc11_ = _loc3_[_loc8_].length) > 0)
               {
                  _loc12_ = 0;
                  while(_loc12_ < _loc11_)
                  {
                     if((_loc9_ = this.textField.getCharBoundaries(param2 + _loc6_ + _loc8_ + _loc12_)) != null)
                     {
                        _loc10_ = false;
                        break;
                     }
            ...
            if(_loc10_ == false)
            {
               ...
               _loc6_ += String(_loc4_[_loc7_].text).length;
               _loc7_++;
            }
            else
            {
               _loc6_ += _loc3_[_loc8_].length;
            }
            _loc8_++;
         }
         return _loc4_;
      ...
      protected function linesSplit() : Array
      {
         ...
         while(_loc6_ < _loc3_)
         {
            ...
            {
               _loc9_ = true;
               if((_loc10_ = _loc8_.length) > 0)
               {
                  _loc11_ = 0;
                  while(_loc11_ < _loc10_)
                  {
                     if((_loc7_ = this.textField.getCharBoundaries(_loc4_ + _loc11_)) != null)
                     {
                        _loc9_ = false;
                        break;
                     }
      ...
      protected function customSplit(param1:String, param2:uint, param3:Array) : Array
      {
         ...
         while(_loc8_ < _loc5_)
         {
            ...
            {
               _loc11_ = true;
               if((_loc12_ = _loc9_.length) > 0)
               {
                  _loc13_ = 0;
                  while(_loc13_ < _loc12_)
                  {
                     if((_loc10_ = this.textField.getCharBoundaries(param2 + _loc6_ + _loc13_)) != null)
                     {
                        _loc11_ = false;
                        break;
                     }
      ...
      protected function clonePattern(param1:Object) : Object
      {
         ...
         if(param1 != null)
         {
            ...
            _loc6_ = new (_loc5_ = getDefinitionByName(_loc4_) as Class)();
            _loc7_ = _loc3_.length();
            _loc8_ = 0;
            while(_loc8_ < _loc7_)
            {
               if((_loc9_ = _loc3_[_loc8_]).@declaredBy == _loc4_)
               {
