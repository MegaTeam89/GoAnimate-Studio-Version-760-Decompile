package
{
   ...
   public class _anifire_components_skins_DefaultDropDownListSkinWatcherSetupUtil implements IWatcherSetupUtil2
   {
       
      
      public function _anifire_components_skins_DefaultDropDownListSkinWatcherSetupUtil()
      {
         super();
      }
      ...
      {
         DefaultDropDownListSkin.watcherSetupUtil = new _anifire_components_skins_DefaultDropDownListSkinWatcherSetupUtil();
      }
