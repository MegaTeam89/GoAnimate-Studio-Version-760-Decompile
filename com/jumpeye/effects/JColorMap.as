package com.jumpeye.effects
{
   ...
   public dynamic class JColorMap extends Sprite
   {
      ...
      private function getDistort(param1:*, param2:*) : BitmapFilter
      {
         ...
         return new DisplacementMapFilter(_loc3_,new Point(0,0),1,1,param1,param1,"color");
      }
      ...
      private function randomColor(param1:String, param2:Number) : Number
      {
         ...
         {
            case "red":
               _loc4_ = (_loc4_ = ((_loc3_ & 16711680) >> 16) + param2) >= 255 ? 255 : _loc4_;
               break;
            case "green":
               _loc5_ = (_loc5_ = ((_loc3_ & 65280) >> 8) + param2) >= 255 ? 255 : _loc5_;
               break;
            case "blue":
               _loc6_ = (_loc6_ = (_loc3_ & 255) + param2) >= 255 ? Number(255) : Number(_loc6_);
               break;
            case undefined:
      ...
      public function colorGradient(param1:Shape, param2:*, param3:*, param4:*, param5:*, param6:*, param7:*, param8:*, param9:*, param10:*) : *
      {
         ...
         var _loc15_:Matrix;
         (_loc15_ = new Matrix()).createGradientBox(param2,param3,param8,param9 / 2 - param2 / 2,param10 / 2 - param3 / 2);
