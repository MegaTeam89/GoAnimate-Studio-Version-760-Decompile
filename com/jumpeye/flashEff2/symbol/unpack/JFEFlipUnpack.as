package com.jumpeye.flashEff2.symbol.unpack
{
   ...
   public class JFEFlipUnpack
   {
      ...
      public function motionChagedHorizontal(param1:*) : *
      {
         ...
         this.tweenObject.angleVertical += Math.PI * this.tweenObject.prop - this.tweenObject.transformPosition;
      ...
      public function firstDistortion(param1:*, param2:*, param3:*) : *
      {
         ...
         var _loc12_:Array;
         _loc4_ = (_loc12_ = this.renderObject(param1))[0].x;
         _loc5_ = _loc12_[0].y;
         _loc6_ = _loc12_[1].x;
         _loc7_ = _loc12_[1].y;
         _loc8_ = _loc12_[2].x;
      ...
      {
         var _loc5_:*;
         (_loc5_ = this).tweenObject.transformPosition = 0;
