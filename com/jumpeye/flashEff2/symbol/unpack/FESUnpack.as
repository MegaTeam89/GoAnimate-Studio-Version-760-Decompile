package com.jumpeye.flashEff2.symbol.unpack
{
   ...
   public class FESUnpack extends IFlashEffSymbol
   {
      ...
      {
         param1.y += param1.texture.height;
         param1.x += param1.texture.width / 2;
         ...
         switch(Number(this.preset))
         {
            ...
            case 7:
               ...
               if(transitionType == "hide")
               {
                  ...
                  {
                     owner.objectsArray[i - 1][0].y -= owner.objectsArray[i - 1][0].height / 2;
                  }
                  if(owner.objectsArray[i - 1][0].packType == "packY")
                  {
                     owner.objectsArray[i - 1][0].x -= Math.ceil(owner.objectsArray[i - 1][0].width / 2);
                  }
               ...
               if(transitionType == "show")
               {
                  ...
                  switch(obj.packType)
                  {
                     case "packX":
                        ...
                        break;
                     case "packXH":
                        owner.objectsArray[i - 1][0].matrixty += owner.objectsArray[i - 1][0].height / 2;
                        owner.objectsArray[i - 1][0].tweenFirstDistortionX = Math.PI / 2;
                        ...
                        break;
                     case "packY":
                        owner.objectsArray[i - 1][0].x -= owner.objectsArray[i - 1][0].width / 2;
                        ...
                        break;
                     case "packYW":
                        owner.objectsArray[i - 1][0].matrixtx += owner.objectsArray[i - 1][0].width / 2;
                        owner.objectsArray[i - 1][0].tweenFirstDistortionY = -Math.PI / 2;
                  ...
                  while(i < _stepsNumber)
                  {
                     ...
                     switch(tempObj.packType)
                     {
                        ...
                        case "packXH":
                           ...
                           tempObj.matrixty -= tempObj.height;
                           tempObj.matrixtx -= tempObj.width;
                           break;
                        case "packY":
                           tempObj.packType = "packYW";
                           tempObj.x -= tempObj.width;
                  ...
                  owner.endSquareTranistion = function(param1:MovieClip):*
                  {
                     ...
                     var _loc7_:*;
                     (_loc7_ = new Matrix()).tx = param1.matrixtx;
      ...
      public function invertTexture(param1:BitmapData, param2:Number, param3:Number, param4:Number, param5:Number) : *
      {
         ...
         (_loc6_ = new BitmapData(param1.width,param1.height,true,16777215)).draw(param1);
      ...
      {
         param1.y += param1.texture.height / 2;
         var _loc2_:* = param1.texture.width;
         var _loc3_:* = param1.texture.height;
