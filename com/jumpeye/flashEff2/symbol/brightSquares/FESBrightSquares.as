   ...
   public class FESBrightSquares extends IFlashEffSymbol
   {
      ...
      private function applyTransition(param1:String) : void
      {
         ...
         while(_loc3_ < lines)
         {
            ...
            while(_loc4_ < columns)
            {
               (_loc7_ = new Object()).depthCoef = presetArray[_loc3_][_loc4_];
               _loc7_.i = _loc3_;
               _loc7_.j = _loc4_;
