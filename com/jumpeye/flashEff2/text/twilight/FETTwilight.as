package com.jumpeye.flashEff2.text.twilight
{
   ...
   public class FETTwilight extends IFlashEffText
   {
      ...
      protected function startTransition(param1:Boolean = true) : void
      {
         ...
         (_loc5_ = new BitmapData(this.target.width,this.target.height,true,0)).draw(this.target);
         ...
         var _loc7_:Sprite;
         (_loc7_ = new Sprite()).graphics.beginFill(this._lightColor);
         ...
         var _loc8_:Shader;
         (_loc8_ = new Shader()).byteCode = ByteArray(new this.lightBeam());
