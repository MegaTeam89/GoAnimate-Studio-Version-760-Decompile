package com.jumpeye.flashEff2.text.horizontalDisolve
{
   ...
   public class FETHorizontalDisolve extends IFlashEffText
   {
      ...
      private var _groupSize:Number = 8;
      ...
      private var _glowAmount:Number = 4;
      ...
      public function FETHorizontalDisolve(param1:JUIComponent = null)
      {
      ...
      protected function setPositionTween(param1:*, param2:*) : *
      {
         ...
         var _loc5_:* = bol == true ? param1.clip.trueY : param1.clip.x - randRange(-maxHorizontalSpace,maxHorizontalSpace);
      ...
      protected function hdlYChange(param1:*, param2:*, param3:*, param4:*) : *
      {
         ...
         var _loc6_:*;
         if(_loc6_ = bol == true ? param1.clip.x < param3 * percLet : param1.clip.x > Math.abs(param3 - param4) * (1 - percLet))
         {
      ...
      protected function startTransition(param1:Boolean = true) : void
      {
         ...
         while(i < lin)
         {
            ...
            while(j < _loc3_)
            {
               ...
               _loc5_ = bol == true ? _loc4_.clip.x - randRange(-maxHorizontalSpace,maxHorizontalSpace) : _loc4_.clip.x;
