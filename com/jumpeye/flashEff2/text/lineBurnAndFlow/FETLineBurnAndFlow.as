package com.jumpeye.flashEff2.text.lineBurnAndFlow
{
   ...
   public class FETLineBurnAndFlow extends IFlashEffText
   {
      ...
      private function getSkew(param1:*, param2:*) : BitmapFilter
      {
         ...
         var _loc5_:* = 1;
         var _loc6_:* = param2;
         return new DisplacementMapFilter(param1,_loc3_,_loc4_,_loc5_,0,_loc6_,"color",0,0);
      }
         ...
         if(owner is Object)
         {
            if(owner.elements is Array)
            {
               ...
               while(_loc3_ < _loc2_)
               {
                  ...
                  while(_loc4_ < _loc5_)
                  {
                     _loc7_ = (_loc6_ = owner.elements[_loc3_][_loc4_]).clip;
                     _loc6_.flow = 0;
      ...
      protected function startTransition(param1:Boolean = true) : void
      {
         ...
         _loc4_ = (_loc5_ = JFETPreset.getPresetsArray(_loc10_.preset,_loc2_)).timeMatrix;
         ...
         while(_loc6_ < _loc3_)
         {
            ...
            {
               (_loc14_ = owner.elements[_loc6_][_loc7_] = {}).clip = _loc2_[_loc6_][_loc7_];
