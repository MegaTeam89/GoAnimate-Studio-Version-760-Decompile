   ...
   public class FETXYResolve extends IFlashEffText
   {
      ...
      protected function startTransition(param1:Boolean = true) : void
      {
         ...
         while(_loc6_ < _loc3_)
         {
            ...
            {
               (_loc17_ = this.elements[_loc6_][_loc7_] = {}).clip = _loc2_[_loc6_][_loc7_];
               ...
               _loc17_.endX -= _loc17_.clip.width * (_loc17_.endScale - 1) / 2;
               _loc17_.endY -= _loc17_.clip.height * (_loc17_.endScale - 1) / 2;
