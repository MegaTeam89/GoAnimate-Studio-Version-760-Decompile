   ...
   public class FETStationPanels extends IFlashEffText
   {
      ...
      private function checkDictionary() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            while(_loc4_ < _loc3_)
            {
               _loc6_ = (_loc5_ = objMatrix[_loc2_][_loc4_]).textField.text;
               _loc7_ = _loc5_.textField.getTextFormat();
               if((_loc8_ = checkChar(_loc6_,_loc7_)) == -1)
               {
                  superChars.push({
                     "ch":_loc6_,
                     "tf":_loc7_
      ...
      protected function startTransition(param1:Boolean = true) : void
      {
         ...
         _loc3_ = (_loc4_ = JFETPreset.getPresetsArray(_loc7_,objMatrix)).timeMatrix;
         ...
         lineCollection = [];
         var _loc9_:*;
         var _loc10_:* = (_loc9_ = objMatrix[0][0]).textField.getTextFormat();
         for(_loc5_ in chars)
         {
            superChars.push({
               "ch":chars[_loc5_],
         ...
         while(_loc5_ < _loc2_)
         {
            ...
            {
               (_loc12_ = owner.elements[_loc5_][_loc6_] = {}).clip = objMatrix[_loc5_][_loc6_];
               _loc12_.clip.visible = false;
               (_loc13_ = new JCharLine()).blurFactor = blurAmount;
