package com.jumpeye.flashEff2.text.industrial
{
   ...
   public class FETIndustrial2 extends IFlashEffText
   {
      ...
      protected function motionChange() : void
      {
         ...
         while(_loc1_ < _loc5_)
         {
            _loc8_ = (_loc7_ = propOwner.timeline.frames[_loc4_][_loc1_].element).elementTimeline[propOwner.timeline.frames[_loc4_][_loc1_].effectIndex];
            ...
            _loc12_ = (_loc11_ = Math.abs(_loc10_ - _loc7_.lastBlur) * this.blurCoeficient) * _loc8_.blurX;
      ...
      protected function startTransition(param1:Boolean = true) : void
      {
         ...
         {
            _loc14_ = 0;
            if((_loc15_ = this.target.getLineLength(_loc7_)) > 0)
            {
               _loc10_[_loc7_] = [];
               while(_loc14_ < _loc15_)
               {
                  _loc17_ = _loc10_[_loc7_].push(Math.floor(Math.random() * this.maxChars + 1));
                  _loc14_ += _loc10_[_loc7_][_loc17_ - 1];
               }
               _loc16_ = _loc10_[_loc7_].length;
               _loc10_[_loc7_][_loc16_ - 1] -= _loc14_ - _loc15_;
            }
            _loc7_++;
         }
         ...
         while(_loc4_ < _loc3_)
         {
            ...
            {
               (_loc19_ = propOwner.elements[_loc4_][_loc5_] = {}).clip = _loc2_[_loc4_][_loc5_];
               ...
               _loc21_ = (_loc20_ = _loc19_.clip.width) / 2;
         ...
         while(_loc4_ < propOwner.timeLen)
         {
            ...
            while(_loc5_ < propOwner.timeline.frames[_loc4_].length)
            {
               ...
               if((_loc19_ = _loc28_.element).isFirstEffect != true)
               {
               ...
               {
                  if((_loc30_ = _loc19_.effect[_loc28_.effectIndex]) == "up" || _loc30_ == "down")
                  {
      ...
      protected function setRegPoint(param1:*, param2:Number, param3:Number) : void
      {
         ...
         {
            param1.childs[_loc4_].x -= param2;
            param1.childs[_loc4_].y -= param3;
         }
         param1.x += param2;
         param1.y += param3;
      }
      ...
      protected function filterEffect(param1:Sprite, param2:Number, param3:Number, param4:Number, param5:uint = 2) : void
      {
         ...
         var _loc8_:Array;
         (_loc8_ = new Array()).push(_loc6_,_loc7_);
      ...
      protected function motionFinish() : void
      {
         ...
         if(propOwner.currentLevel > -1)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               (_loc4_ = propOwner.alphaElements[_loc2_].clip).visible = this.isShow;
               _loc2_++;
            }
         }
         propOwner.alphaElements = [];
         ...
         if(propOwner.currentLevel < propOwner.timeLen)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = (_loc5_ = propOwner.timeline.frames[propOwner.currentLevel][_loc2_]).element;
