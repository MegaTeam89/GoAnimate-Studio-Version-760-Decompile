   ...
   public class FETIndustrial extends IFlashEffText
   {
      ...
      protected function motionChange() : void
      {
         ...
         while(_loc1_ < _loc5_)
         {
            ...
            _loc11_ = (_loc10_ = Math.abs(_loc7_.clip[_loc8_.blurRel] - _loc7_.lastBlur) * this.blurCoeficient) * _loc8_.blurX;
      ...
      protected function startTransition(param1:Boolean = true) : void
      {
         ...
         while(_loc4_ < propOwner.timeLen)
         {
            ...
            while(_loc5_ < propOwner.timeline.frames[_loc4_].length)
            {
               ...
               if((_loc19_ = _loc26_.element).isFirstEffect != true)
               {
               ...
               {
                  if((_loc28_ = _loc19_.effect[_loc26_.effectIndex]) == "up" || _loc28_ == "down")
                  {
      ...
      protected function motionFinish() : void
      {
         ...
         if(propOwner.currentLevel < propOwner.timeLen)
         {
            ...
            while(_loc2_ < _loc1_)
            {
               _loc3_ = (_loc4_ = propOwner.timeline.frames[propOwner.currentLevel][_loc2_]).element;
