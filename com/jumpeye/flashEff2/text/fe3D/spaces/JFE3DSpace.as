   ...
   public class JFE3DSpace
   {
      ...
      public function update3D() : void
      {
         ...
         while(_loc9_ < this.numChildren)
         {
            ...
            _loc1_ = (_loc11_ = this.renderObject(_loc10_))[0].x + this.camX;
      ...
      public function reverseRender(param1:Array) : Array
      {
         ...
         {
            _loc7_ = (_loc6_ = projectPoint(param1[_loc3_]))[2];
      ...
      public function rotate(param1:Number, param2:Number, param3:Number) : *
      {
         ...
         var _loc4_:Number;
         if((_loc4_ = Math.sqrt(param1 * param1 + param2 * param2 + param3 * param3)) > 0.0001)
         {
            param1 /= _loc4_;
            param2 /= _loc4_;
            param3 /= _loc4_;
