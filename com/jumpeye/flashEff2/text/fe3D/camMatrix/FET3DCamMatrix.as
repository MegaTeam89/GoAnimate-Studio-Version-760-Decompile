package com.jumpeye.flashEff2.text.fe3D.camMatrix
{
   ...
   public class FET3DCamMatrix extends IFlashEffText
   {
      ...
      protected function motionChange() : void
      {
         ...
         {
            (_loc9_ = _loc7_.virtualObject.corners)[0][2] = _loc9_[1][2] = _loc9_[2][2] = _loc9_[3][2] = _loc7_.startZ * Math.abs(_loc1_);
      ...
      protected function startTransition(param1:Boolean = true) : void
      {
         ...
         {
            this.tweenObject.customEase.points = [new Point(0.06279069767441861,0),new Point(0.18037216881962526,0.7274123700450625),new Point(0.19069767441860466,0.7395833333333333),new Point(0.3674418604651163,0.9479166666666666),new Point(0.8863636363636365,1)];
         }
         else
         {
            this.tweenObject.customEase.points = [new Point(0.15813953488372093,0),new Point(0.6441860465116279,0.06944444444444442),new Point(0.8023255813953488,0.26041666666666663),new Point(0.820407234233116,0.2822524044941377),new Point(0.9325581395348838,1)];
         }
