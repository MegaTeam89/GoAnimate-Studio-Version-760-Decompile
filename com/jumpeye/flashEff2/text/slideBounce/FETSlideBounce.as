package com.jumpeye.flashEff2.text.slideBounce
{
   ...
   public class FETSlideBounce extends IFlashEffText
   {
      ...
      protected function startTransition(param1:Boolean = true) : void
      {
         ...
         _loc9_ = (_loc8_ = Math.max(1,_loc8_)) < 26 ? "chars" : "words";
         ...
         _loc4_ = (_loc5_ = JFETPreset.getPresetsArray(_loc8_,_loc2_)).timeMatrix;
         ...
         while(_loc6_ < _loc3_)
         {
            ...
            {
               (_loc11_ = owner.elements[_loc6_][_loc7_] = {}).clip = _loc2_[_loc6_][_loc7_];
      ...
      private function getParity(param1:*) : Boolean
      {
         ...
         var _loc3_:* = param1 / 2;
         var _loc4_:*;
         return (_loc4_ = _loc3_ - Math.floor(_loc3_)) == 0;
      }
