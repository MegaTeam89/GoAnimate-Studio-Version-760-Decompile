package com.jumpeye.flashEff2.text.smartSlide
{
   ...
   public class FETSmartSlide extends IFlashEffText
   {
         ...
         if(owner is Object)
         {
            if(owner.elements is Array)
            {
               ...
               while(_loc2_ < _loc1_)
               {
                  ...
                  while(_loc3_ < _loc4_)
                  {
                     (_loc5_ = owner.elements[_loc2_][_loc3_]).clip = objMatrix[_loc2_][_loc3_];
      ...
      protected function startTransition(param1:Boolean = true) : void
      {
         ...
         _loc3_ = (_loc4_ = JFETPreset.getPresetsArray(_loc7_.preset,objMatrix)).timeMatrix;
         ...
         while(_loc5_ < _loc2_)
         {
            ...
            {
               (_loc11_ = owner.elements[_loc5_][_loc6_] = {}).clip = objMatrix[_loc5_][_loc6_];
