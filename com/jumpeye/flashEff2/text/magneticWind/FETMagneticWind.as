package com.jumpeye.flashEff2.text.magneticWind
{
   ...
   public class FETMagneticWind extends IFlashEffText
   {
      ...
      protected function motionChange(param1:Object) : void
      {
         ...
         var _loc5_:Number;
         var _loc6_:* = _loc5_ = Number(param1.prop);
      ...
      protected function startTransition(param1:Boolean) : void
      {
         ...
         _loc4_ = (_loc5_ = JFETPreset.getPresetsArray(preset,_loc2_)).timeMatrix;
         ...
         while(_loc6_ < _loc3_)
         {
            ...
            while(_loc7_ < _loc15_)
            {
               ...
               if((_loc17_ = Math.floor(Math.random() * 4)) > 2)
               {
                  _loc17_ = 2;
               }
               ...
               _loc16_.endX -= _loc16_.clip.width * (_loc16_.maxScaleAmount - 1) / 2;
               _loc16_.endY -= _loc16_.clip.height * (_loc16_.maxScaleAmount - 1) / 2;
