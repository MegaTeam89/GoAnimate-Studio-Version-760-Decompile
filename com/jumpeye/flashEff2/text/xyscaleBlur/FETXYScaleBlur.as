package com.jumpeye.flashEff2.text.xyscaleBlur
{
   ...
   public class FETXYScaleBlur extends IFlashEffText
   {
       
      
      private var _maxScale:Number = 1.5;
      
      private var _maxBlurX:Number = 15;
      
      private var _maxBlurY:Number = 15;
      ...
      private var _positionX:Number = 60;
      ...
      public function FETXYScaleBlur(param1:JUIComponent = null)
      {
         super();
      ...
      {
         var _loc3_:* = maxBlurX * (1 - param1.pos);
         var _loc4_:* = maxBlurY * (1 - param1.pos);
