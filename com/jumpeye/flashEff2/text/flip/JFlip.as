package com.jumpeye.flashEff2.text.flip
{
   ...
   public class JFlip
   {
      ...
      private function motionChagedHorizontal(param1:*) : *
      {
         ...
         this.tweenObject.angleVertical += Math.PI * param1.prop - this.tweenObject.transformPosition;
      ...
      public function firstDistortion(param1:*, param2:*, param3:*) : *
      {
         ...
         var _loc13_:Array;
         _loc5_ = (_loc13_ = this.renderObject(_loc4_))[0].x;
         _loc6_ = _loc13_[0].y;
         _loc7_ = _loc13_[1].x;
         _loc8_ = _loc13_[1].y;
         _loc9_ = _loc13_[2].x;
      ...
      public function flipEffect(param1:*, param2:Number, param3:*, param4:*) : *
      {
         ...
         owner = param1;
         var _loc6_:*;
         (_loc6_ = this).tweenObject.transformPosition = 0;
