package com.jumpeye.flashEff2.text.flip
{
   ...
   public class FETFlip extends IFlashEffText
   {
      ...
      protected function startTransition(param1:String) : void
      {
         ...
         var _loc4_:Object;
         var _loc5_:* = (_loc4_ = JFETPreset.getAliasPreset(this.preset)).splitter;
         ...
         switch(_axis)
         {
            ...
            case "down":
               for(_loc9_ in _loc6_)
               {
                  ...
                  _loc6_[_loc9_].x += _loc6_[_loc9_].width;
                  _loc6_[_loc9_].y += _loc6_[_loc9_].height;
               }
               break;
            case "left":
               break;
            ...
            case "vertical":
               for(_loc9_ in _loc6_)
               {
                  ...
                  _loc6_[_loc9_].x += _loc6_[_loc9_].width / 2;
                  _loc6_[_loc9_].y += _loc6_[_loc9_].height / 2;
               }
               break;
            case "horizontal":
               for(_loc9_ in _loc6_)
