package cmodule.oggvorbisencoder
{
   ...
   public final class FSM_vorbis_encode_tonemask_setup extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         mstate.esp -= 0;
         _loc1_ = 0;
         _loc10_ = lf64(mstate.ebp + 12);
         _loc2_ = int(_loc10_);
         _loc3_ = int(_loc2_ + 1);
         _loc4_ = li32(mstate.ebp + 24);
         _loc5_ = int(_loc3_ * 20);
         _loc6_ = int(_loc2_ * 20);
         _loc11_ = Number(_loc2_);
         _loc5_ = int(_loc4_ + _loc5_);
         _loc4_ += _loc6_;
         _loc6_ = int(li32(mstate.ebp + 20));
         _loc7_ = li32(_loc4_);
         _loc8_ = li32(_loc5_);
         _loc10_ -= _loc11_;
         _loc9_ = li32(mstate.ebp + 8);
         ...
         sf32(_loc11_ = _loc11_ = _loc13_ + _loc11_,_loc6_ + 12);
         _loc7_ = li32(_loc4_ + 4);
         _loc8_ = li32(_loc5_ + 4);
         _loc11_ = Number(_loc8_);
         _loc13_ = Number(_loc7_);
         _loc11_ *= _loc10_;
         sf32(_loc11_ = _loc11_ = (_loc13_ *= _loc12_) + _loc11_,_loc6_ + 16);
         _loc7_ = li32(_loc4_ + 8);
         _loc8_ = li32(_loc5_ + 8);
         _loc11_ = Number(_loc8_);
         _loc13_ = Number(_loc7_);
         _loc11_ *= _loc10_;
         sf32(_loc11_ = _loc11_ = (_loc13_ *= _loc12_) + _loc11_,_loc6_ + 20);
         _loc11_ = lf32(_loc4_ + 12);
         _loc13_ = (_loc13_ = lf32(_loc5_ + 12)) * _loc10_;
         sf32(_loc11_ = _loc11_ = (_loc11_ *= _loc12_) + _loc13_,_loc6_ + 24);
         _loc11_ = lf32(_loc4_ + 16);
         _loc13_ = (_loc13_ = lf32(_loc5_ + 16)) * _loc10_;
         _loc11_ = (_loc11_ *= _loc12_) + _loc13_;
         _loc4_ = li32(mstate.ebp + 28);
         _loc3_ <<= 2;
         _loc5_ = _loc2_ << 2;
         sf32(_loc11_ = _loc11_,_loc6_ + 28);
         _loc3_ = int(_loc4_ + _loc3_);
         _loc4_ = li32(_loc4_ += _loc5_);
         _loc3_ = int(li32(_loc3_));
         _loc11_ = Number(_loc3_);
         _loc13_ = Number(_loc4_);
         _loc11_ *= _loc10_;
         _loc11_ = (_loc13_ *= _loc12_) + _loc11_;
         _loc3_ = int(li32(mstate.ebp + 32));
         _loc2_ *= 68;
         sf32(_loc11_ = _loc11_,_loc6_ + 496);
         _loc2_ = _loc3_ + _loc2_;
         _loc3_ = int(_loc1_);
         while(_loc1_ < 17)
         {
            _loc5_ = int(li32(_loc4_ = _loc2_ + _loc3_));
            ...
            sf32(_loc11_ = _loc11_,_loc4_ + 36);
            _loc3_ += 4;
            _loc1_ += 1;
         }
