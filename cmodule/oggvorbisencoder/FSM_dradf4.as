package cmodule.oggvorbisencoder
{
   ...
   public final class FSM_dradf4 extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         si32(_loc5_ = _loc3_ * _loc2_,mstate.ebp + -27);
         _loc5_ = li32(mstate.ebp + 16);
         si32(_loc6_ = int(li32(mstate.ebp + 20)),mstate.ebp + -18);
         _loc6_ = int(li32(mstate.ebp + 24));
         _loc7_ = li32(mstate.ebp + 28);
         ...
         _loc12_ = _loc2_ << 3;
         _loc13_ = _loc2_ << 1;
         si32(_loc13_ = (_loc13_ = int(li32(mstate.ebp + -27))) << 1,mstate.ebp + -9);
         _loc13_ = int(_loc5_);
         _loc14_ = int(li32(mstate.ebp + -18));
         _loc15_ = _loc13_;
         _loc16_ = li32(mstate.ebp + -9);
         _loc17_ = li32(mstate.ebp + -27);
         while(true)
         {
            ...
            _loc33_ = lf32(_loc21_ = _loc4_ + _loc15_);
            ...
            sf32(_loc33_ = _loc33_ -= _loc34_,_loc14_);
         ...
         if(_loc2_ >= 2)
         {
            if(_loc2_ != 2)
            {
               ...
               while(_loc17_ < _loc3_)
               {
                  ...
                  while(_loc25_ < _loc2_)
                  {
                     ...
                     _loc33_ = lf32(_loc32_ = _loc6_ + _loc18_);
                     ...
                     _loc40_ = _loc40_;
                     _loc35_ = _loc35_;
                     _loc42_ = (_loc36_ = _loc36_) - _loc35_;
                     ...
                     sf32(_loc33_ = _loc35_,_loc27_ + -8);
                     _loc26_ += -8;
                     _loc18_ += 8;
                     _loc25_ += 2;
                  }
            ...
            _loc1_ = 0;
            _loc4_ = (_loc4_ = _loc3_ << 1) | 1;
            _loc6_ = int(_loc3_ + 1);
            _loc6_ = int(_loc2_ * _loc6_);
            _loc4_ = int(_loc2_ * _loc4_);
            _loc7_ = (_loc7_ = li32(mstate.ebp + -27)) + _loc2_;
            _loc8_ = _loc2_ << 2;
            _loc4_ <<= 2;
            _loc6_ <<= 2;
            _loc9_ = _loc2_ << 4;
            ...
            _loc7_ += -1;
            _loc12_ = int(_loc8_);
            _loc13_ = int(li32(mstate.ebp + -18));
            _loc14_ = int(li32(mstate.ebp + -9));
            while(true)
            {
               _loc7_ += _loc14_;
               if(_loc1_ >= _loc3_)
               ...
               _loc34_ = lf32(_loc15_ = _loc6_ + _loc11_);
               _loc35_ = lf32(_loc14_);
               _loc36_ = _loc36_ = _loc34_ - _loc35_;
               _loc33_ = _loc33_ = (_loc36_ = _loc36_) * (_loc33_ = Number(_loc33_));
               _loc36_ = lf32(_loc14_ = int(_loc8_ + _loc11_));
               _loc33_ = _loc33_;
               ...
               _loc35_ = _loc35_;
               _loc34_ = (_loc34_ = _loc34_) * _loc35_;
               _loc33_ = _loc33_;
               _loc16_ = _loc10_ + _loc13_;
               _loc34_ = _loc34_;
               sf32(_loc33_,_loc16_ + -4);
               _loc33_ = lf32(_loc11_ = int(_loc4_ + _loc11_));
               sf32(_loc33_ = _loc33_ = (_loc34_ = _loc34_) - _loc33_,_loc15_);
               sf32(_loc33_ = _loc33_ = (_loc33_ = lf32(_loc11_)) + _loc34_,_loc16_);
