package cmodule.oggvorbisencoder
{
   ...
   public final class FSM_fit_line extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         _loc6_ = 0;
         _loc4_ += 1108;
         _loc7_ = li32(mstate.ebp + 16);
         _loc8_ = li32(mstate.ebp + 20);
         _loc20_ = _loc19_;
         _loc21_ = _loc19_;
         _loc22_ = _loc19_;
         _loc23_ = _loc19_;
         while(true)
         {
            ...
            _loc11_ = (_loc10_ = li32(_loc2_ + 52)) + _loc9_;
            _loc22_ = Number(_loc11_);
            _loc23_ = lf32(_loc4_);
            _loc22_ = (_loc22_ = _loc22_) * _loc23_;
            _loc11_ = _loc9_ + 1;
            _loc22_ = _loc22_;
            _loc22_ = _loc22_ = (_loc22_ = _loc22_) / (_loc23_ = Number(Number(_loc11_)));
         ...
         if((_loc25_ = (_loc26_ = _loc19_ * _loc21_) - _loc25_) > _loc24_)
         {
            _loc24_ = _loc22_ * _loc23_;
            _loc19_ = (_loc19_ *= _loc20_) - _loc24_;
            _loc20_ *= _loc22_;
            _loc20_ = (_loc21_ = _loc23_ * _loc21_) - _loc20_;
            ...
            if((_loc7_ = li32(_loc8_)) <= -1)
            {
               si32(_loc7_ = 0,_loc8_);
               mstate.eax = _loc7_;
            }
            else
            {
