      ...
      override public final function work() : void
      {
         switch(state)
         {
            ...
            case 4:
               ...
               mstate.esp -= 4;
               FSM_vorbis_encode_tonemask_setup.start();
               break;
            case 6:
               mstate.esp += 28;
               §§goto(addr3757);
            ...
            case 8:
               ...
               si32(this.i11,mstate.esp + 20);
               mstate.esp -= 4;
               FSM_vorbis_encode_compand_setup.start();
            case 9:
               §§goto(addr4058);
            case 10:
               §§goto(addr4058);
            ...
            case 12:
               ...
               si32(this.i11,mstate.esp + 16);
               mstate.esp -= 4;
               FSM_vorbis_encode_peak_setup.start();
            case 13:
               §§goto(addr4403);
            case 14:
               §§goto(addr4403);
            ...
            case 16:
               ...
               mstate.esp -= 4;
               FSM_vorbis_encode_noisebias_setup.start();
            case 17:
               §§goto(addr4694);
            case 18:
               §§goto(addr4694);
            ...
            case 29:
               §§goto(addr6832);
            default:
               throw "Invalid state in _vorbis_encode_init_vbr";
         }
         mstate.eax = this.i1;
