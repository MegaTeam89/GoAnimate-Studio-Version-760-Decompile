package cmodule.oggvorbisencoder
{
   ...
   public final class FSM_res1_inverse extends Machine
   {
      ...
      public function FSM_res1_inverse()
      {
         super();
      }
      ...
      {
         var _loc1_:FSM_res1_inverse = null;
         _loc1_ = new FSM_res1_inverse();
      ...
      override public final function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               if(this.i0 != 0)
               {
                  this.i4 = _vorbis_book_decodev_add;
                  mstate.esp -= 20;
            ...
            case 1:
               ...
               break;
            default:
               throw "Invalid state in _res1_inverse";
         }
         mstate.eax = this.i0;
