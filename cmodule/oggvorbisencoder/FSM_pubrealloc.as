      ...
      override public final function work() : void
      {
         switch(state)
         {
            case 0:
               ...
               mstate.esp -= 4096;
               this.i0 = li32(_malloc_active_2E_3023);
               ...
               if(this.i0 >= 1)
               {
                  ...
                  {
                     this.i2 = 2;
                     si32(this.i2,_malloc_active_2E_3023);
                  }
                  this.i2 = 88;
                  si32(this.i2,_val_2E_939);
                  this.i2 = 0;
               }
               else
               {
                  this.i0 = 1;
                  si32(this.i0,_malloc_active_2E_3023);
                  this.i0 = li8(_malloc_started_2E_3024_2E_b);
                  if(this.i0 == 0)
                  {
                     if(this.i2 == 0)
                     {
                        this.i0 = 0;
                        this.i4 = li32(_val_2E_939);
                        ...
                        while(true)
                        {
                           ...
                           while(true)
                           {
                              ...
                              mstate.esp += 4;
                              si32(this.i0,_px);
                              si32(this.i4,_val_2E_939);
                              this.i0 = 1;
                              si8(this.i0,_malloc_started_2E_3024_2E_b);
                           }
                        }
                        this.i0 = __2E_str95;
                        mstate.esp -= 20;
                  ...
                  if(this.i0 == 0)
                  {
                     if(this.i3 == 0)
                     {
                        if(this.i1 != 0)
                        {
                           ...
                           addr1208:
                           mstate.esp += 4;
                           si32(this.i3,_malloc_active_2E_3023);
                           this.i1 = this.i3;
                           this.i0 = this.i1;
                           this.i1 = this.i3;
                           break;
                     ...
                     else
                     {
                        ...
                        else
                        {
                           if(this.i1 == 0)
                           {
                              ...
                              si32(this.i1,_malloc_active_2E_3023);
                              this.i1 = this.i0 & 1;
                              this.i0 = this.i1;
                              this.i1 = this.i3;
                              break;
