package cmodule.oggvorbisencoder
{
   ...
   public final class FSM_vorbis_encode_compand_setup extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         mstate.esp -= 0;
         _loc7_ = 0;
         _loc8_ = lf64(mstate.ebp + 12);
         _loc1_ = int(int(_loc8_));
         _loc9_ = Number(_loc1_);
         _loc2_ = int(li32(mstate.ebp + 28));
         _loc1_ <<= 3;
         _loc8_ -= _loc9_;
         ...
         _loc8_ = (_loc9_ = _loc10_ * _loc11_) + _loc8_;
         _loc1_ = int(int(_loc8_));
         _loc9_ = Number(_loc1_);
         _loc2_ = int((_loc8_ -= _loc9_) == _loc7_ ? 1 : 0);
         ...
         while(_loc2_ < 40)
         {
            _loc6_ = li32(_loc5_ = _loc1_ + _loc4_);
            _loc5_ = li32(_loc5_ + 160);
            _loc9_ = Number(_loc5_);
            _loc10_ = Number(_loc6_);
            _loc9_ *= _loc7_;
            _loc9_ = (_loc10_ *= _loc8_) + _loc9_;
            _loc5_ = _loc3_ + _loc4_;
            sf32(_loc9_ = _loc9_,_loc5_ + 336);
            _loc4_ += 4;
            _loc2_ += 1;
         }
