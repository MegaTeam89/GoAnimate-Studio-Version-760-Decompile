   ...
   class TextFieldI extends IO
   {
      ...
      function TextFieldI(param1:TextField)
      {
         ...
         this.m_tf.addEventListener(TextEvent.TEXT_INPUT,function(param1:TextEvent):*
         {
            ...
            (_loc5_ = m_tf.getTextFormat(_loc3_,_loc4_)).bold = false;
            ...
            if(param1.text.indexOf("\n") >= 0)
            {
               ...
               while(_loc8_ < _loc2_)
               {
                  if((_loc11_ = (_loc5_ = m_tf.getTextFormat(_loc8_,_loc8_ + 1)).bold) != null && !_loc11_.valueOf())
                  {
                     _loc7_ += _loc6_.charAt(_loc8_);
                  }
                  _loc8_++;
               }
               _loc9_ = (_loc7_ = _loc7_.replace(/\r/g,"\n")).lastIndexOf("\n");
