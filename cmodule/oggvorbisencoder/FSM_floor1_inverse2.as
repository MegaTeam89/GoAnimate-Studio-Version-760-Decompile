      ...
      public static function start() : void
      {
         ...
         if(_loc5_ != 0)
         {
            ...
            while(true)
            {
               ...
               _loc12_ = (_loc8_ = int(li32(_loc8_))) << 2;
               _loc15_ = (_loc12_ = int(li32(_loc12_ = int(_loc5_ + _loc12_)))) & 32767;
               if(_loc12_ != _loc15_)
               {
                  _loc8_ = int(_loc11_);
               }
               ...
               {
                  _loc8_ <<= 2;
                  _loc11_ = li32((_loc8_ = int(_loc4_ + _loc8_)) + 836);
                  if((_loc8_ = int((_loc8_ = int(li32(_loc9_))) * _loc15_)) <= -1)
                  {
                     _loc8_ = 0;
                  }
                  else
                  ...
                  _loc8_ = int((_loc12_ = int(_loc8_)) - _loc3_);
                  _loc15_ = int(_loc11_ - _loc10_);
                  _loc17_ = int((_loc16_ = _loc8_ / _loc15_) * _loc15_);
                  _loc18_ = _loc8_ >> 31;
                  _loc19_ = _loc17_ >> 31;
                  ...
                  if(_loc10_ < _loc19_)
                  {
                     _loc18_ = int(_FLOOR1_fromdB_LOOKUP);
                     _loc20_ = _loc3_ << 2;
                     _loc21_ = _loc10_ << 2;
                     _loc18_ += _loc20_;
                     _loc24_ = lf32(_loc20_ = int(_loc2_ + _loc21_));
                     _loc25_ = lf32(_loc18_);
                     sf32(_loc24_ = _loc24_ *= _loc25_,_loc20_);
                  }
                  _loc18_ = 0;
                  _loc20_ = _loc10_ << 2;
                  _loc20_ = int((_loc20_ = int(_loc7_ + _loc20_)) + 4);
                  _loc10_ += 1;
                  while(true)
                  {
                     _loc21_ = int(_loc3_);
                     ...
                     _loc22_ = _FLOOR1_fromdB_LOOKUP;
                     _loc23_ = int(_loc16_ + _loc8_);
                     _loc23_ = int((_loc18_ += _loc17_) < _loc15_ ? int(_loc16_) : int(_loc23_));
                     _loc23_ = (_loc21_ += _loc23_) << 2;
                     _loc22_ += _loc23_;
                     _loc24_ = lf32(_loc3_);
                     _loc25_ = lf32(_loc22_);
                     _loc24_ *= _loc25_;
                     _loc22_ = _loc18_ - _loc15_;
                     sf32(_loc24_ = _loc24_,_loc3_);
            ...
            while(true)
            {
               ...
               _loc24_ = lf32(_loc3_);
               _loc25_ = lf32(_loc2_);
               sf32(_loc24_ = _loc24_ *= _loc25_,_loc3_);
               _loc3_ = int(_loc5_ + 4);
               _loc4_ += 1;
            }
            _loc1_ = 1;
