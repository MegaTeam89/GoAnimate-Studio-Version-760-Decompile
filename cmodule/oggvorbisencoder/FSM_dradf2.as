   ...
   public final class FSM_dradf2 extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         while(true)
         {
            ...
            sf32(_loc21_ = _loc21_ += _loc22_,_loc1_);
            _loc21_ = lf32(_loc13_);
            _loc22_ = lf32(_loc16_);
         ...
         if(_loc2_ >= 2)
         {
            if(_loc2_ != 2)
            {
               ...
               while(true)
               {
                  ...
                  while(_loc14_ < _loc2_)
                  {
                     ...
                     _loc21_ = lf32(_loc20_ = _loc7_ + _loc16_);
                     ...
                     _loc25_ = _loc25_;
                     _loc25_ = _loc25_ = (_loc25_ = _loc25_) - (_loc26_ = Number(_loc26_));
                     _loc26_ = lf32((_loc19_ = _loc15_ + _loc16_) + 8);
                     _loc25_ = _loc25_;
                     ...
                     _loc22_ = _loc22_;
                     _loc21_ = (_loc21_ = _loc21_) + _loc22_;
                     sf32(_loc22_ = _loc23_,_loc17_ + -8);
                     _loc21_ = _loc21_;
                     _loc22_ = lf32(_loc19_ + 4);
                     _loc21_ = _loc21_;
                     sf32(_loc22_ = _loc22_ += _loc21_,_loc20_ + 4);
                     sf32(_loc21_ = _loc21_ = (_loc22_ = lf32(_loc19_ + 4)) - _loc21_,_loc17_ + -12);
                     _loc16_ += 8;
                     _loc14_ += 2;
                     _loc17_ += -8;
                  }
            ...
            while(true)
            {
               ...
               _loc12_ = _loc9_ << 2;
               sf32(_loc21_ = _loc21_ = -(_loc21_ = lf32(_loc12_ = int(_loc5_ + _loc12_))),_loc11_);
               sf32(_loc21_ = lf32(_loc10_),_loc6_ + -4);
