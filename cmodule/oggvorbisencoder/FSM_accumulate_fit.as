package cmodule.oggvorbisencoder
{
   ...
   public final class FSM_accumulate_fit extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         _loc3_ = li32(mstate.ebp + 28);
         _loc4_ = li32(mstate.ebp + 32);
         si32(_loc6_,_loc2_);
         ...
         while(true)
         {
            ...
            _loc27_ = lf32(_loc14_ = _loc9_ + _loc22_);
            mstate.esp -= 4;
            sf32(_loc27_,mstate.esp);
            mstate.esp -= 4;
            FSM_vorbis_dBquant138.start();
            _loc14_ = mstate.eax;
            mstate.esp += 4;
            if(_loc14_ == 0)
            {
            ...
            {
               _loc28_ = lf32(_loc15_ = _loc8_ + _loc22_);
               _loc29_ = lf32(_loc4_);
               _loc28_ = _loc28_ += _loc29_;
               _loc27_ = _loc27_;
               if((_loc28_ = _loc28_) >= _loc27_)
               {
