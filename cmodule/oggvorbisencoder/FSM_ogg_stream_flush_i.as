               ...
               if(_loc2_ != 0)
               {
                  ...
                  if(_loc7_ == 0)
                  {
                     ...
                     while(true)
                     {
                        ...
                        _loc11_ = int(li8(_loc11_ = int((_loc11_ = int(li32(_loc8_))) + _loc10_)));
                        _loc10_ += 4;
                        _loc7_ += 1;
                        if(_loc11_ < 255)
                        {
                           _loc2_ = int(_loc10_ = 0);
                           break;
                        }
                     }
                  }
                  else
                  {
                     ...
                     while(true)
                     {
                        ...
                        _loc16_ = (_loc10_ = int(li8(_loc10_ = int((_loc10_ = int(li32(_loc8_))) + _loc18_)))) + _loc14_;
                        if(_loc10_ >= 255)
                        {
                           _loc10_ = 0;
                        }
                        ...
                        {
                           _loc12_ = li32(_loc10_ = int((_loc10_ = int(li32(_loc11_))) + _loc19_));
                  ...
                  if(_loc5_ != 0)
                  {
                     ...
                     si8(_loc5_ = 0,_loc1_ + 44);
                     si8(_loc5_,_loc1_ + 45);
                     _loc10_ = int(li32(_loc5_ = int(li32(_loc1_ + 16))));
                     ...
                     {
                        si8(_loc10_ = 1,_loc11_);
                     }
                     if((_loc14_ = li32(_loc9_)) == 0)
                     {
                        si8(_loc10_ |= 2,_loc11_);
                     }
                     if((_loc14_ = li32(_loc1_ + 328)) != 0)
                     {
                        if((_loc14_ = li32(_loc3_)) == _loc7_)
                        {
                           si8(_loc10_ |= 4,_loc11_);
                        }
                     }
                     si32(_loc10_ = 1,_loc9_);
                     _loc9_ = 0;
                     while((_loc10_ = int(_loc9_ + 6)) < 14)
                     {
                     ...
                     _loc9_ = 0;
                     si32(_loc10_ = int(_loc2_ + 1),_loc8_);
                     _loc8_ = int(_loc9_);
                     while((_loc9_ = int(_loc8_ + 18)) < 22)
                     {
                     ...
                     else
                     {
                        ...
                        while(_loc3_ > _loc6_)
                        {
                           _loc7_ = int(_crc_lookup);
                           _loc8_ = int(li8(_loc8_ = int((_loc8_ = int(li32(_loc5_))) + _loc6_)));
                           _loc8_ = (_loc8_ = (_loc9_ = int(_loc4_ >>> 24)) ^ _loc8_) << 2;
                           _loc7_ = int(li32(_loc7_ += _loc8_));
                           _loc4_ <<= 8;
                           _loc6_ += 1;
                           _loc4_ ^= _loc7_;
                        }
                        ...
                        while(_loc1_ > _loc3_)
                        {
                           _loc6_ = int(_crc_lookup);
                           _loc7_ = int(li8(_loc7_ = int((_loc7_ = int(li32(_loc2_))) + _loc3_)));
                           _loc7_ = (_loc7_ = (_loc8_ = int(_loc4_ >>> 24)) ^ _loc7_) << 2;
                           _loc6_ = int(li32(_loc6_ += _loc7_));
                           _loc4_ <<= 8;
                           _loc3_ += 1;
                           _loc4_ ^= _loc6_;
                        }
