         ...
         if(_loc3_ != 0)
         {
            if(_loc2_ != _loc1_)
            {
                  ...
                  if((_loc6_ = (_loc6_ = _loc4_ | _loc5_) & 3) != 0)
                  {
                     if((_loc6_ = (_loc6_ = _loc4_ ^ _loc5_) & 3) == 0)
                     {
                        ...
                        if(_loc3_ != 0)
                        {
                           ...
                           while(true)
                           {
                              _loc5_ = int(li8(_loc5_ = int(_loc1_ + _loc4_)));
               ...
               else
               {
                  ...
                  _loc6_ = (_loc5_ = int(_loc1_ + _loc3_)) | _loc4_;
                  _loc7_ = int(_loc4_);
                  _loc8_ = _loc5_;
                  if((_loc6_ &= 3) == 0)
                  {
                  ...
                  {
                     _loc6_ = 0;
                     _loc4_ = int((_loc4_ = (_loc4_ = _loc5_ ^ _loc4_) & 3) != 0 ? 1 : 0);
                     ...
                     do
                     {
                        _loc7_ = int((_loc7_ = _loc6_ ^ -1) + _loc3_);
                  ...
                  else
                  {
                     ...
                     do
                     {
                        _loc7_ = int(li32((_loc7_ = int(_loc6_ + _loc3_)) + -4));
                  ...
                  if(_loc2_ != 0)
                  {
                     ...
                     {
                        _loc5_ = _loc4_ ^ -1;
                        _loc6_ = int(li8(_loc6_ = int(_loc3_ + _loc5_)));
