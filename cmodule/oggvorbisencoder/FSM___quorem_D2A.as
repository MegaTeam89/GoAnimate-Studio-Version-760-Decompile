package cmodule.oggvorbisencoder
{
   ...
   public final class FSM___quorem_D2A extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         {
            _loc10_ = (_loc9_ = _loc3_ + -1) << 2;
            _loc11_ = int(li32((_loc11_ = int(_loc2_ + _loc10_)) + 20));
            _loc12_ = int(li32((_loc10_ = int(_loc1_ + _loc10_)) + 20));
            _loc11_ += 1;
            _loc10_ += 20;
            if((_loc11_ = int(uint(_loc12_) / uint(_loc11_))) != 0)
            {
               _loc12_ = 20;
               ...
               while(true)
               {
                  ...
                  mstate.esp -= 16;
                  si32(_loc21_ = li32(_loc21_),mstate.esp);
                  ...
                  _loc21_ = mstate.eax;
                  _loc22_ = mstate.edx;
                  _loc24_ = li32(_loc23_ = _loc8_ + _loc12_);
               ...
               if((_loc10_ = int(li32(_loc10_))) == 0)
               {
                  if((_loc4_ = _loc3_ + -2) <= 0)
                  {
                     _loc3_ = int(_loc9_);
                  }
                  else
                  {
                     _loc10_ = 0;
                     _loc12_ = _loc3_ << 2;
                     _loc12_ = int((_loc12_ = int(_loc8_ + _loc12_)) + 12);
                     _loc3_ += -1;
                     while(true)
                     {
                        _loc13_ = _loc12_;
               ...
               else
               {
                  ...
                  {
                     _loc10_ = _loc3_ ^ -1;
                     _loc12_ = (_loc10_ = int(_loc6_ + _loc10_)) << 2;
               ...
               else
               {
                  ...
                  _loc6_ = _loc11_ + 1;
                  _loc10_ = int(_loc2_);
                  _loc12_ = int(_loc11_ = int(_loc2_));
                  _loc13_ = _loc10_;
                  while(true)
                  {
                     _loc14_ = 0;
                     _loc15_ = int(li32(_loc15_ = int(_loc7_ + _loc3_)));
                     _loc17_ = li32(_loc16_ = _loc8_ + _loc3_);
