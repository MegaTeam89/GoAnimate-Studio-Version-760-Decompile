   ...
   public final class FSM_imalloc extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         else if(uint(_loc1_) <= uint(2048))
         {
            ...
            _loc4_ = _loc2_ << 2;
            if((_loc4_ = int(li32(_loc4_ = int(_loc3_ + _loc4_)))) == 0)
            {
               _loc3_ = 4096;
               mstate.esp -= 4;
               ...
               if(_loc3_ != 0)
               {
                  _loc5_ = int((_loc5_ = int((_loc4_ = int((_loc4_ = 4096) >>> _loc2_)) + 31)) >>> 3);
                  _loc6_ = 1;
                  ...
                  if(_loc6_ <= _loc8_)
                  {
                     ...
                     if(_loc13_ < _loc9_)
                     {
                        ...
                        {
                           _loc15_ = 1;
                           _loc17_ = int((_loc17_ = (_loc16_ = int(_loc13_ + _loc14_)) & -32) >>> 3);
                           _loc16_ &= 31;
                           _loc18_ = li32((_loc17_ = int(_loc12_ + _loc17_)) + 16);
                           _loc15_ <<= _loc16_;
                     ...
                     if(_loc3_ == _loc8_)
                     {
                        if(_loc7_ >= 1)
                        {
                           ...
                           do
                           {
                              ...
                              _loc13_ >>>= 3;
                              _loc9_ <<= _loc14_;
                              _loc14_ = int(li32((_loc13_ = int(_loc12_ + _loc13_)) + 16));
                              _loc9_ ^= -1;
                              si32(_loc9_ = _loc14_ & _loc9_,_loc13_ + 16);
                              si16(_loc9_ = int((_loc9_ = int(li16(_loc10_))) + -1),_loc10_);
                              _loc5_ -= _loc6_;
                              _loc7_ += 1;
                           }
                           while(_loc5_ >= 1);
                           ...
                           _loc5_ = int(_loc7_ + -1);
                           si16(_loc4_ = int((_loc4_ -= _loc5_) + -1),_loc11_);
                        }
                     }
                     ...
                     si32(_loc5_ = int(li32(_loc3_)),_loc8_);
                     si32(_loc12_,_loc3_);
                     ...
                     if((_loc5_ = (_loc8_ = int(li32(_loc6_ = int(_loc5_)))) & 1) != 0)
                     {
                        _loc7_ = 0;
                        _loc5_ = 1;
                     }
                     ...
                     si16(_loc5_ = int((_loc5_ = int(li16(_loc4_ + 12))) + -1),_loc4_ + 12);
                     if((_loc5_ &= 65535) == 0)
                     {
                        _loc5_ = 0;
                        _loc2_ <<= 2;
                     ...
                     if(_loc3_ == 0)
                     {
                        ...
                        _loc6_ = int((_loc6_ = int(li32(_loc4_ + 4))) + _loc2_);
                     ...
                     else
                     {
                        ...
                        _loc4_ = int(li8(_malloc_zero_2E_b));
                        _loc2_ = int(_loc3_ + _loc2_);
                        if(_loc2_ != 0)
                        {
                           _loc3_ = _loc4_ & 1;
