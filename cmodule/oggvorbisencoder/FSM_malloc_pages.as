   ...
   public final class FSM_malloc_pages extends Machine
   {
      ...
      public static function start() : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            while(true)
            {
               ...
               if(uint(_loc2_) >= uint(_loc3_))
               {
                  ...
                  if(_loc2_ == _loc3_)
                  {
                     ...
                     if(_loc2_ != 0)
                     {
                        si32(_loc6_ = int(li32(_loc1_ + 4)),_loc2_ + 4);
                     }
                     _loc2_ = int(li32(_loc1_ + 4));
                     si32(_loc4_ = li32(_loc4_),_loc2_);
            ...
            _loc1_ += 4095;
            _loc1_ = int((_loc6_ = _loc1_ & -4096) + _loc3_);
            if(uint(_loc1_) >= uint(_loc6_))
            {
               ...
               if(_loc2_ == 0)
               {
                  ...
                  _loc2_ += -1;
                  si32(_loc7_ = _loc2_ - _loc7_,_last_index);
                  ...
                  if(_loc4_ != 0)
                  {
                     ...
                     _loc8_ = int((_loc7_ = _loc4_ >>> 12) - _loc6_);
                     ...
                     {
                        _loc5_ = 0;
                        _loc6_ = int((_loc6_ = int((_loc6_ = (_loc6_ = int(_loc7_ - _loc6_)) << 2) + _loc9_)) + 4);
                        _loc2_ += -1;
                        do
                        {
                           si32(_loc7_ = 3,_loc6_);
                           _loc6_ += 4;
                        }
                        while((_loc5_ += 1) != _loc2_);
